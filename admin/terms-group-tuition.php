...
if(isset($_REQUEST['crs-saveBI'])){
 ...
 header('Location:terms-group-tuition.php');
 exit();
}
...
$queryTCBI = $conDB->query("SELECT * FROM tk_page_manage_translation WHERE pmt_id='80'");
...
$queryTCBM = $conDB->query("SELECT * FROM tk_page_manage_translation WHERE pmt_id='81'");
        ...
        <div class="col-lg-12">
         <div class="ibox float-e-margins">
          <div class="ibox-title">
           <h5><b>Terms for Group Tuition</b></h5>
