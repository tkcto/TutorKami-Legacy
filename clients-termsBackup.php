...
$_SESSION['getPage'] = "Client's Term";
...
<section class="profile">
 <div class="main-body">
    <div class="container">
<form method="post" action="client-terms-of-accepting.php" class="sigPad">
       <h1 class="text-center text-uppercase blue-txt"><?php echo CLIENT_TERMS; ?></h1><hr>
