...
$queryLevel = $conn->query("SELECT tc_id, tc_title, tc_description FROM tk_tution_course WHERE tc_id !='9' ORDER BY tc_id ASC");
          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown menuul">
				...
				<ul class="dropdown-menu">
					<li><a href="https://www.tutorkami.com/my/index">Home Page</a></li>
					<li><a href="https://www.tutorkami.com/my/about">About Us</a></li>
				</ul>
            </li>
            <li class="dropdown menuul">
				...
				<ul class="dropdown-menu">
					<li><a href="https://www.tutorkami.com/my/search_tutor">Search Tutor</a></li>
					<li><a href="https://www.tutorkami.com/my/parent_faq">FAQs</a></li>
					<li><a href="https://www.tutorkami.com/my/request_a_tutor?tutor_id=i3be8gz">Contact Us</a></li>
				</ul>
            </li>
            <li class="dropdown menuul">
				...
				<ul class="dropdown-menu">
					<li><a href="https://www.tutorkami.com/my/tutor.php">Tutor’s Page</a></li>
					<li><a href="https://www.tutorkami.com/my/search_job.php">Latest Jobs</a></li>
					<li><a href="https://www.tutorkami.com/my/register.php">Register</a></li>
					<li><a href="https://www.tutorkami.com/my/tutor_faq.php">FAQs</a></li>
					<li><a href="https://www.tutorkami.com/my/login.php">Log In</a></li>
				</ul>
            </li>
          </ul>
        </div><!--/.nav-collapse -->
...
<div class="hover_bkgr_fricc">
    ...
    <div>
            <div class="form-group label-floating" style="text-align: left;">
                <label class="control-label">Lokasi Anda <small>(diperlukan)</small></label>
                <input style="color: black;" id="selectStateModal" name="selectStateModal" type="text" class="form-control my_form_control">
            </div>
          
            <button style="margin-top:10px;" type="button" class="btn btn-success" onClick="Procced()">TERUSKAN</button>
    </div>
</div>
		                    ...
		                    <form action="" method="">
		                    	...
		                    	<div class="wizard-header">
		                        	<h1 class="wizard-title h1Title" id="search-term">
		                        	   Harga Tuisyen di Rumah dan Online di Lokasi Anda
		                        	</h1>
		                    	</div>
								<div class="wizard-navigation">
									<ul>
			                            <li><a href="#about" data-toggle="tab">Maklumat</a></li>
			                            <li><a href="#address" data-toggle="tab">Harga</a></li>
			                        </ul>
								</div>
		                        ...
		                        <div class="tab-content">
		                            <div class="tab-pane" id="about">
		                              <div class="row">
		                                	<h4 class="info-text">  Masukkan maklumat di bawah</h4>
		                                	<div class="col-sm-12">
		                                    	<div class="form-group label-floating">
		                                        	<label class="control-label">Tahap <small>(required)</small></label>
	                                        		<select class="form-control" id="selectthisLevel" name="selectthisLevel">
														<option disabled="" selected=""></option>
														<?PHP
														if($rowLevel > 0){
															while ($resultLevel = $queryLevel->fetch_assoc()) {
																?><option value="<?PHP echo $resultLevel['tc_id']; ?>"> <?PHP echo $resultLevel['tc_description']; ?> </option><?PHP
															}
														}
														?>
		                                        	</select>
													...
													<div class="form-group label-floating">
			                                          	<label class="control-label"> Lokasi Anda atau taip 'Online Tuition' <small>(required)</small></label>
			                                          	<input id="selectState" name="selectState" type="text" class="form-control my_form_control">
			                                        </div>
			                                        
												<div class="form-group label-floating">
		                                        	<label class="control-label">Bilangan Pelajar</label>
	                        	...
	                        	<div class="wizard-footer">
	                            	<div class="pull-right">
	                                    ...
	                                    <input type='button' class='btn btn-finish btn-fill btn-danger btn-wd' name='finish' value='Laman Utama' onClick="closeWindow()" />
	                                </div>
	                                <div class="pull-left">
