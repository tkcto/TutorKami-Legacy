...
foreach($TotalUser as $data){
     $ThisJan  = mysqli_query($conn," SELECT * FROM tk_sales_sub WHERE main_id = '".$_GET['id']."' AND tab_name = '".$data."' AND row_no != '0' AND month = 'Jan' ORDER BY FIELD(row_no, '999999') DESC, row_no ASC ");
        $rowCountJan = mysqli_num_rows($ThisJan);
     $ThisFeb  = mysqli_query($conn," SELECT * FROM tk_sales_sub WHERE main_id = '".$_GET['id']."' AND tab_name = '".$data."' AND row_no != '0' AND month = 'Feb' ORDER BY FIELD(row_no, '999999') DESC, row_no ASC ");
        $rowCountFeb = mysqli_num_rows($ThisFeb);
     $ThisMar  = mysqli_query($conn," SELECT * FROM tk_sales_sub WHERE main_id = '".$_GET['id']."' AND tab_name = '".$data."' AND row_no != '0' AND month = 'Mar' ORDER BY FIELD(row_no, '999999') DESC, row_no ASC ");
        $rowCountMar = mysqli_num_rows($ThisMar);
     $ThisApr  = mysqli_query($conn," SELECT * FROM tk_sales_sub WHERE main_id = '".$_GET['id']."' AND tab_name = '".$data."' AND row_no != '0' AND month = 'Apr' ORDER BY FIELD(row_no, '999999') DESC, row_no ASC ");
        $rowCountApr = mysqli_num_rows($ThisApr);
     $ThisMay  = mysqli_query($conn," SELECT * FROM tk_sales_sub WHERE main_id = '".$_GET['id']."' AND tab_name = '".$data."' AND row_no != '0' AND month = 'May' ORDER BY FIELD(row_no, '999999') DESC, row_no ASC ");
        $rowCountMay = mysqli_num_rows($ThisMay);
     $ThisJun  = mysqli_query($conn," SELECT * FROM tk_sales_sub WHERE main_id = '".$_GET['id']."' AND tab_name = '".$data."' AND row_no != '0' AND month = 'Jun' ORDER BY FIELD(row_no, '999999') DESC, row_no ASC ");
        $rowCountJun = mysqli_num_rows($ThisJun);
     $ThisJul  = mysqli_query($conn," SELECT * FROM tk_sales_sub WHERE main_id = '".$_GET['id']."' AND tab_name = '".$data."' AND row_no != '0' AND month = 'Jul' ORDER BY FIELD(row_no, '999999') DESC, row_no ASC ");
        $rowCountJul = mysqli_num_rows($ThisJul);
     $ThisAug  = mysqli_query($conn," SELECT * FROM tk_sales_sub WHERE main_id = '".$_GET['id']."' AND tab_name = '".$data."' AND row_no != '0' AND month = 'Aug' ORDER BY FIELD(row_no, '999999') DESC, row_no ASC ");
        $rowCountAug = mysqli_num_rows($ThisAug);
     $ThisSep  = mysqli_query($conn," SELECT * FROM tk_sales_sub WHERE main_id = '".$_GET['id']."' AND tab_name = '".$data."' AND row_no != '0' AND month = 'Sep' ORDER BY FIELD(row_no, '999999') DESC, row_no ASC ");
        $rowCountSep = mysqli_num_rows($ThisSep);
     $ThisOct  = mysqli_query($conn," SELECT * FROM tk_sales_sub WHERE main_id = '".$_GET['id']."' AND tab_name = '".$data."' AND row_no != '0' AND month = 'Oct' ORDER BY FIELD(row_no, '999999') DESC, row_no ASC ");
        $rowCountOct = mysqli_num_rows($ThisOct);
     $ThisNov  = mysqli_query($conn," SELECT * FROM tk_sales_sub WHERE main_id = '".$_GET['id']."' AND tab_name = '".$data."' AND row_no != '0' AND month = 'Nov' ORDER BY FIELD(row_no, '999999') DESC, row_no ASC ");
        $rowCountNov = mysqli_num_rows($ThisNov);
     $ThisDec  = mysqli_query($conn," SELECT * FROM tk_sales_sub WHERE main_id = '".$_GET['id']."' AND tab_name = '".$data."' AND row_no != '0' AND month = 'Dec' ORDER BY FIELD(row_no, '999999') DESC, row_no ASC ");
        $rowCountDec = mysqli_num_rows($ThisDec);
		
		//SUM(tk.no4) as total FROM tk_sales_sub as tk WHERE no2 IN (SELECT no2 FROM tk_sales_sub as t WHERE t.no2 = tk.no2 AND no7 != '' AND no5 NOT LIKE '%trial%' ) AND
     
	 $ThisJan2  = mysqli_query($conn," SELECT tk.no4 as total FROM tk_sales_sub as tk WHERE no2 IN (SELECT no2 FROM tk_sales_sub as t WHERE t.no2 = tk.no2 AND no7 != '' AND no5 NOT LIKE '%trial%' ) AND main_id = '".$_GET['id']."' AND tab_name = '".$data."' AND row_no != '0' AND month = 'Jan' AND no3 = 'R.F' ORDER BY FIELD(row_no, '999999') DESC, row_no ASC ");
        $rowCountJan2 = mysqli_num_rows($ThisJan2);
     $ThisFeb2  = mysqli_query($conn," SELECT tk.no4 as total FROM tk_sales_sub as tk WHERE no2 IN (SELECT no2 FROM tk_sales_sub as t WHERE t.no2 = tk.no2 AND no7 != '' AND no5 NOT LIKE '%trial%' ) AND main_id = '".$_GET['id']."' AND tab_name = '".$data."' AND row_no != '0' AND month = 'Feb' AND no3 = 'R.F' ORDER BY FIELD(row_no, '999999') DESC, row_no ASC ");
        $rowCountFeb2 = mysqli_num_rows($ThisFeb2);
     $ThisMar2  = mysqli_query($conn," SELECT tk.no4 as total FROM tk_sales_sub as tk WHERE no2 IN (SELECT no2 FROM tk_sales_sub as t WHERE t.no2 = tk.no2 AND no7 != '' AND no5 NOT LIKE '%trial%' ) AND main_id = '".$_GET['id']."' AND tab_name = '".$data."' AND row_no != '0' AND month = 'Mar' AND no3 = 'R.F' ORDER BY FIELD(row_no, '999999') DESC, row_no ASC ");
        $rowCountMar2 = mysqli_num_rows($ThisMar2);
     $ThisApr2  = mysqli_query($conn," SELECT tk.no4 as total FROM tk_sales_sub as tk WHERE no2 IN (SELECT no2 FROM tk_sales_sub as t WHERE t.no2 = tk.no2 AND no7 != '' AND no5 NOT LIKE '%trial%' ) AND main_id = '".$_GET['id']."' AND tab_name = '".$data."' AND row_no != '0' AND month = 'Apr' AND no3 = 'R.F' ORDER BY FIELD(row_no, '999999') DESC, row_no ASC ");
        $rowCountApr2 = mysqli_num_rows($ThisApr2);
     $ThisMay2  = mysqli_query($conn," SELECT tk.no4 as total FROM tk_sales_sub as tk WHERE no2 IN (SELECT no2 FROM tk_sales_sub as t WHERE t.no2 = tk.no2 AND no7 != '' AND no5 NOT LIKE '%trial%' ) AND main_id = '".$_GET['id']."' AND tab_name = '".$data."' AND row_no != '0' AND month = 'May' AND no3 = 'R.F' ORDER BY FIELD(row_no, '999999') DESC, row_no ASC ");
        $rowCountMay2 = mysqli_num_rows($ThisMay2);
     $ThisJun2  = mysqli_query($conn," SELECT tk.no4 as total FROM tk_sales_sub as tk WHERE no2 IN (SELECT no2 FROM tk_sales_sub as t WHERE t.no2 = tk.no2 AND no7 != '' AND no5 NOT LIKE '%trial%' ) AND main_id = '".$_GET['id']."' AND tab_name = '".$data."' AND row_no != '0' AND month = 'Jun' AND no3 = 'R.F' ORDER BY FIELD(row_no, '999999') DESC, row_no ASC ");
        $rowCountJun2 = mysqli_num_rows($ThisJun2);
     $ThisJul2  = mysqli_query($conn," SELECT tk.no4 as total FROM tk_sales_sub as tk WHERE no2 IN (SELECT no2 FROM tk_sales_sub as t WHERE t.no2 = tk.no2 AND no7 != '' AND no5 NOT LIKE '%trial%' ) AND main_id = '".$_GET['id']."' AND tab_name = '".$data."' AND row_no != '0' AND month = 'Jul' AND no3 = 'R.F' ORDER BY FIELD(row_no, '999999') DESC, row_no ASC ");
        $rowCountJul2 = mysqli_num_rows($ThisJul2);
     $ThisAug2  = mysqli_query($conn," SELECT tk.no4 as total FROM tk_sales_sub as tk WHERE no2 IN (SELECT no2 FROM tk_sales_sub as t WHERE t.no2 = tk.no2 AND no7 != '' AND no5 NOT LIKE '%trial%' ) AND main_id = '".$_GET['id']."' AND tab_name = '".$data."' AND row_no != '0' AND month = 'Aug' AND no3 = 'R.F' ORDER BY FIELD(row_no, '999999') DESC, row_no ASC ");
        $rowCountAug2 = mysqli_num_rows($ThisAug2);
     $ThisSep2  = mysqli_query($conn," SELECT tk.no4 as total FROM tk_sales_sub as tk WHERE no2 IN (SELECT no2 FROM tk_sales_sub as t WHERE t.no2 = tk.no2 AND no7 != '' AND no5 NOT LIKE '%trial%' ) AND main_id = '".$_GET['id']."' AND tab_name = '".$data."' AND row_no != '0' AND month = 'Sep' AND no3 = 'R.F' ORDER BY FIELD(row_no, '999999') DESC, row_no ASC ");
        $rowCountSep2 = mysqli_num_rows($ThisSep2);
     $ThisOct2  = mysqli_query($conn," SELECT tk.no4 as total FROM tk_sales_sub as tk WHERE no2 IN (SELECT no2 FROM tk_sales_sub as t WHERE t.no2 = tk.no2 AND no7 != '' AND no5 NOT LIKE '%trial%' ) AND main_id = '".$_GET['id']."' AND tab_name = '".$data."' AND row_no != '0' AND month = 'Oct' AND no3 = 'R.F' ORDER BY FIELD(row_no, '999999') DESC, row_no ASC ");
        $rowCountOct2 = mysqli_num_rows($ThisOct2);
     $ThisNov2  = mysqli_query($conn," SELECT tk.no4 as total FROM tk_sales_sub as tk WHERE no2 IN (SELECT no2 FROM tk_sales_sub as t WHERE t.no2 = tk.no2 AND no7 != '' AND no5 NOT LIKE '%trial%' ) AND main_id = '".$_GET['id']."' AND tab_name = '".$data."' AND row_no != '0' AND month = 'Nov' AND no3 = 'R.F' ORDER BY FIELD(row_no, '999999') DESC, row_no ASC ");
        $rowCountNov2 = mysqli_num_rows($ThisNov2);
     $ThisDec2  = mysqli_query($conn," SELECT tk.no4 as total FROM tk_sales_sub as tk WHERE no2 IN (SELECT no2 FROM tk_sales_sub as t WHERE t.no2 = tk.no2 AND no7 != '' AND no5 NOT LIKE '%trial%' ) AND main_id = '".$_GET['id']."' AND tab_name = '".$data."' AND row_no != '0' AND month = 'Dec' AND no3 = 'R.F' ORDER BY FIELD(row_no, '999999') DESC, row_no ASC ");
        $rowCountDec2 = mysqli_num_rows($ThisDec2);
...
*/
        	...
        	$totalGP = (($rowJan['no4'] - $rowJan['no7']) + $rowJan2['no4']);
        	...
        	$Jan++;
    	        ...
    	        $no4 = 0;    	        $no7 = 0;    	        $rf = 0;    	        $Total = 0;    	        $sqlSum  = mysqli_query($conn," SELECT SUM(no4) as total FROM tk_sales_sub WHERE main_id = '".$rowJan['main_id']."' AND tab_name = '".$rowJan['tab_name']."' AND month = '".$rowJan['month']."' AND no7 != '' AND row_no != '0' ");    	        while($rowSum = mysqli_fetch_array($sqlSum)) {					$no4 = number_format((float)$rowSum['total'], 2, '.', '');      	        }    	        $sqlSum  = mysqli_query($conn," SELECT SUM(tk.no4) as total FROM tk_sales_sub as tk WHERE no2 IN (SELECT no2 FROM tk_sales_sub as t WHERE t.no2 = tk.no2 AND no7 != '' AND no5 NOT LIKE '%trial%' ) AND main_id = '".$rowJan['main_id']."' AND tab_name = '".$rowJan['tab_name']."' AND month = '".$rowJan['month']."' AND no3 = 'R.F' AND row_no != '0'  ");    	        while($rowSum = mysqli_fetch_array($sqlSum)) {					$rf = number_format((float)$rowSum['total'], 2, '.', '');      	        }    	        $sqlSum  = mysqli_query($conn," SELECT SUM(no7) as total FROM tk_sales_sub WHERE main_id = '".$rowJan['main_id']."' AND tab_name = '".$rowJan['tab_name']."' AND month = '".$rowJan['month']."' AND no7 != '' AND row_no != '0'  ");    	        while($rowSum = mysqli_fetch_array($sqlSum)) {					$no7 = number_format((float)$rowSum['total'], 2, '.', '');      	        }				$sumSumGP =  (($no4 - $no7) + $rf);
...
*/
        	...
        	$totalGP = (($rowFeb['no4'] - $rowFeb['no7']) + $rowFeb2['no4']);
        	...
        	$Feb++;
    	        ...
    	        $sqlSum  = mysqli_query($conn," SELECT SUM(tk.no4) as total FROM tk_sales_sub as tk WHERE no2 IN (SELECT no2 FROM tk_sales_sub as t WHERE t.no2 = tk.no2 AND no7 != '' AND no5 NOT LIKE '%trial%' ) AND main_id = '".$rowFeb['main_id']."' AND tab_name = '".$rowFeb['tab_name']."' AND month = '".$rowFeb['month']."' AND no3 = 'R.F' AND row_no != '0'  ");    	        
				while($rowSum = mysqli_fetch_array($sqlSum)) 
				{					
...
*/
        	...
        	$totalGP = (($rowMar['no4'] - $rowMar['no7']) + $rowMar2['no4']);
        	...
        	$Mar++;
    	        ...
    	        $sqlSum  = mysqli_query($conn," SELECT SUM(tk.no4) as total FROM tk_sales_sub as tk WHERE no2 IN (SELECT no2 FROM tk_sales_sub as t WHERE t.no2 = tk.no2 AND no7 != '' AND no5 NOT LIKE '%trial%' ) AND main_id = '".$rowMar['main_id']."' AND tab_name = '".$rowMar['tab_name']."' AND month = '".$rowMar['month']."' AND no3 = 'R.F' AND row_no != '0'  ");    	        
				while($rowSum = mysqli_fetch_array($sqlSum)) {					
					$rf = number_format((float)$rowSum['total'], 2, '.', '');      	        
				}
...
*/
        	...
        	$totalGP = (($rowApr['no4'] - $rowApr['no7']) + $rowApr2['no4']);
        	...
        	$Apr++;
    	        ...
    	        $sqlSum  = mysqli_query($conn," SELECT SUM(tk.no4) as total FROM tk_sales_sub as tk WHERE no2 IN (SELECT no2 FROM tk_sales_sub as t WHERE t.no2 = tk.no2 AND no7 != '' AND no5 NOT LIKE '%trial%' ) AND main_id = '".$rowApr['main_id']."' AND tab_name = '".$rowApr['tab_name']."' AND month = '".$rowApr['month']."' AND no3 = 'R.F' AND row_no != '0'  ");    	        while($rowSum = mysqli_fetch_array($sqlSum)) {					$rf = number_format((float)$rowSum['total'], 2, '.', '');      	        }
...
*/
        	...
        	$totalGP = (($rowMay['no4'] - $rowMay['no7']) + $rowMay2['no4']);
        	...
        	$May++;
    	        ...
    	        $sqlSum  = mysqli_query($conn," SELECT SUM(tk.no4) as total FROM tk_sales_sub as tk WHERE no2 IN (SELECT no2 FROM tk_sales_sub as t WHERE t.no2 = tk.no2 AND no7 != '' AND no5 NOT LIKE '%trial%' ) AND main_id = '".$rowMay['main_id']."' AND tab_name = '".$rowMay['tab_name']."' AND month = '".$rowMay['month']."' AND no3 = 'R.F' AND row_no != '0'  ");    	        while($rowSum = mysqli_fetch_array($sqlSum)) {					$rf = number_format((float)$rowSum['total'], 2, '.', '');      	        }
...
*/
        	...
        	$totalGP = (($rowJun['no4'] - $rowJun['no7']) + $rowJun2['no4']);
        	...
        	$Jun++;
    	        ...
    	        $sqlSum  = mysqli_query($conn," SELECT SUM(tk.no4) as total FROM tk_sales_sub as tk WHERE no2 IN (SELECT no2 FROM tk_sales_sub as t WHERE t.no2 = tk.no2 AND no7 != '' AND no5 NOT LIKE '%trial%' ) AND main_id = '".$rowJun['main_id']."' AND tab_name = '".$rowJun['tab_name']."' AND month = '".$rowJun['month']."' AND no3 = 'R.F' AND row_no != '0'  ");    	        while($rowSum = mysqli_fetch_array($sqlSum)) {					$rf = number_format((float)$rowSum['total'], 2, '.', '');      	        }
...
*/
        	...
        	$totalGP = (($rowJul['no4'] - $rowJul['no7']) + $rowJul2['no4']);
        	...
        	$Jul++;
    	        ...
    	        $sqlSum  = mysqli_query($conn," SELECT SUM(tk.no4) as total FROM tk_sales_sub as tk WHERE no2 IN (SELECT no2 FROM tk_sales_sub as t WHERE t.no2 = tk.no2 AND no7 != '' AND no5 NOT LIKE '%trial%' ) AND main_id = '".$rowJul['main_id']."' AND tab_name = '".$rowJul['tab_name']."' AND month = '".$rowJul['month']."' AND no3 = 'R.F' AND row_no != '0'  ");    	        while($rowSum = mysqli_fetch_array($sqlSum)) {					$rf = number_format((float)$rowSum['total'], 2, '.', '');      	        }
...
*/
        	...
        	$totalGP = (($rowAug['no4'] - $rowAug['no7']) + $rowAug2['no4']);
        	...
        	$Aug++;
    	        ...
    	        $sqlSum  = mysqli_query($conn," SELECT SUM(tk.no4) as total FROM tk_sales_sub as tk WHERE no2 IN (SELECT no2 FROM tk_sales_sub as t WHERE t.no2 = tk.no2 AND no7 != '' AND no5 NOT LIKE '%trial%' ) AND main_id = '".$rowAug['main_id']."' AND tab_name = '".$rowAug['tab_name']."' AND month = '".$rowAug['month']."' AND no3 = 'R.F' AND row_no != '0'  ");    	        while($rowSum = mysqli_fetch_array($sqlSum)) {					$rf = number_format((float)$rowSum['total'], 2, '.', '');      	        }
...
*/
        	...
        	$totalGP = (($rowSep['no4'] - $rowSep['no7']) + $rowSep2['no4']);
        	...
        	$Sep++;
    	        ...
    	        $sqlSum  = mysqli_query($conn," SELECT SUM(tk.no4) as total FROM tk_sales_sub as tk WHERE no2 IN (SELECT no2 FROM tk_sales_sub as t WHERE t.no2 = tk.no2 AND no7 != '' AND no5 NOT LIKE '%trial%' ) AND main_id = '".$rowSep['main_id']."' AND tab_name = '".$rowSep['tab_name']."' AND month = '".$rowSep['month']."' AND no3 = 'R.F' AND row_no != '0'  ");    	        while($rowSum = mysqli_fetch_array($sqlSum)) {					$rf = number_format((float)$rowSum['total'], 2, '.', '');      	        }
...
*/
        	...
        	$totalGP = (($rowOct['no4'] - $rowOct['no7']) + $rowOct2['no4']);
        	...
        	$Oct++;
    	        ...
    	        $sqlSum  = mysqli_query($conn," SELECT SUM(tk.no4) as total FROM tk_sales_sub as tk WHERE no2 IN (SELECT no2 FROM tk_sales_sub as t WHERE t.no2 = tk.no2 AND no7 != '' AND no5 NOT LIKE '%trial%' ) AND main_id = '".$rowOct['main_id']."' AND tab_name = '".$rowOct['tab_name']."' AND month = '".$rowOct['month']."' AND no3 = 'R.F' AND row_no != '0'  ");    	        while($rowSum = mysqli_fetch_array($sqlSum)) {					$rf = number_format((float)$rowSum['total'], 2, '.', '');      	        }
...
*/
        	...
        	$totalGP = (($rowNov['no4'] - $rowNov['no7']) + $rowNov2['no4']);
        	...
        	$Nov++;
    	        ...
    	        $sqlSum  = mysqli_query($conn," SELECT SUM(tk.no4) as total FROM tk_sales_sub as tk WHERE no2 IN (SELECT no2 FROM tk_sales_sub as t WHERE t.no2 = tk.no2 AND no7 != '' AND no5 NOT LIKE '%trial%' ) AND main_id = '".$rowNov['main_id']."' AND tab_name = '".$rowNov['tab_name']."' AND month = '".$rowNov['month']."' AND no3 = 'R.F' AND row_no != '0'  ");    	        while($rowSum = mysqli_fetch_array($sqlSum)) {					$rf = number_format((float)$rowSum['total'], 2, '.', '');      	        }
...
*/
        	...
        	$totalGP = (($rowDec['no4'] - $rowDec['no7']) + $rowDec2['no4']);
        	...
        	$Dec++;
    	        ...
    	        $sqlSum  = mysqli_query($conn," SELECT SUM(tk.no4) as total FROM tk_sales_sub as tk WHERE no2 IN (SELECT no2 FROM tk_sales_sub as t WHERE t.no2 = tk.no2 AND no7 != '' AND no5 NOT LIKE '%trial%' ) AND main_id = '".$rowDec['main_id']."' AND tab_name = '".$rowDec['tab_name']."' AND month = '".$rowDec['month']."' AND no3 = 'R.F' AND row_no != '0'  ");    	        while($rowSum = mysqli_fetch_array($sqlSum)) {					$rf = number_format((float)$rowSum['total'], 2, '.', '');      	        }
...
//$objWriter->save('../../admin/excel/nameoffile.xls');
