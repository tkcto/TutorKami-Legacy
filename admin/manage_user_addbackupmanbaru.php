                           ...
                           <div class="panel-body">
                            ...
                            <!--   <div class="clearfix"></div>
                             ...
                             <!--   <div class="clearfix"></div>
                              <div class="hr-line-dashed"></div>
                              <div class="form-group">
                                 <label class="col-sm-2 control-label">Area you can cover: <br>
                                 </label>
                                 <div class="col-sm-10">
                                    <div class="row">
                                       <?php 
                                          ...
                                          <div class="checkbox">                        
                                             ...
                                             <div class="showHide" style="display:none<?php //echo ($checked > 0) ? 'block' : 'none';?>">
                                                ...
                                                <div class="row">
                                                   <div class="col-md-12">
                                                      <div class="checkbox">                                  
                                                         <input type="checkbox" name="other_area_<?php echo $state->st_id;?>" id="other_area_<?php echo $state->st_id;?>" value="1" data-pid="<?php echo $state->st_id;?>" data-cname="cover_area_city_" data-oname="other_area_" data-pname="ca_state_" onchange="toggleOther(this, 'cover_area_other_<?php echo $state->st_id;?>')" <?php echo ($OtherState != '') ? 'checked' : '';?>>
                                                         <label for="other_area_<?php echo $state->st_id;?>">Others ( Enter other area(s) in this state if it's not in the list above)</label>
                                                      </div>
                                                   </div>
                                                   <div class="col-md-12" style="display: <?php echo ($OtherState != '') ? 'block' : 'none';?>;">
                                                      <textarea class="form-control" name="cover_area_other_<?php echo $state->st_id;?>" rows="3" style="resize:none;"><?php echo $OtherState;?></textarea>
                                                   </div>
                                                </div>
                                             </div>
                                             <?php } ?>
                                          ...
                                          <div class="showHide" style="display:none;"<?php //echo $stl; ?>>
                                             ...
                                             <div class="dropPop" <?php //echo $stl; ?>>
                                                <div class="row">
                                                   ...
                                                   ?>
                                                   <div class="col-md-12">  
                                                      <input type="checkbox" name="tutor_subject_<?php echo $course['tc_id'];?>[<?php echo $i; ?>]" id="tutor_subject_<?php echo $course['tc_id'];?>_<?php echo $i; ?>" value="<?php echo $subject['ts_id'];?>" data-pid="<?php echo $course['tc_id'];?>" data-cname="tutor_subject_" data-oname="subject_" data-pname="tu_course_" onchange="check_parent(this)" <?php echo ($sub_chk > 0) ? 'checked' : '';?>> 
                                             ...
                                             <div class="row">
                                                <div class="col-md-12">
                                                   <div class="checkbox">            
                                                      <input type="checkbox" name="subject_<?php echo $course['tc_id'];?>" id="subject_<?php echo $course['tc_id'];?>" value="1" data-pid="<?php echo $course['tc_id'];?>" data-cname="tutor_subject_" data-oname="subject_" data-pname="tu_course_" onchange="toggleOther(this, 'other_subject_<?php echo $course['tc_id'];?>')" <?php echo ($OtherCourse != '') ? 'checked' : '';?>>
                                                      <label for="subject_<?php echo $course['tc_id'];?>" <?php echo ($checked > 0 ) ? 'checked' : '';?>>Others ( Enter other subject(s) for this level if it's not in the list above) </label>
                                                   </div>
                                                </div>
                                                <div class="col-md-12" style="display: <?php echo ($OtherCourse != '') ? 'block' : 'none';?>;">
                                                   <textarea class="form-control" name="other_subject_<?php echo $course['tc_id'];?>" rows="3" style="resize:none;"><?php echo $OtherCourse;?></textarea>
                                                </div>
                                             </div>
                                          </div>
                                          <?php } ?>
                        ...
                        <div id="tab-3" class="tab-pane">
                           <div class="panel-body">
                              ...
                              <ul class="whatsapp">
                                 ...
                                 ?>
                                 <li><img src="<?php echo APP_ROOT.$testimonial['ut_user_testimonial1']; ?>" alt="testimonial1" data-action="zoom" class="cropped img-responsive admin-testm-img"></li>
                                 <li><img src="<?php echo APP_ROOT.$testimonial['ut_user_testimonial2']; ?>" alt="testimonial2" data-action="zoom" class="cropped img-responsive admin-testm-img"></li>
                                 <li><img src="<?php echo APP_ROOT.$testimonial['ut_user_testimonial3']; ?>" alt="testimonial3" data-action="zoom" class="cropped img-responsive admin-testm-img"></li>
                                 <li><img src="<?php echo APP_ROOT.$testimonial['ut_user_testimonial4']; ?>" alt="testimonial4" data-action="zoom" class="cropped img-responsive admin-testm-img"></li>
                                 <?php 
                                     }
                                   }
                                 ?>
