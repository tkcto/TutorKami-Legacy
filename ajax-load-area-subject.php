                          ...
                          <div class="row">
                            ...
                            foreach ($getSubject->data as $key => $subject) { 
                              ...
                              //$sub_chk = system::FireCurl(USER_SUBJECT_URL.'?user_id='.$user_id.'&subject_id='.$subject->ts_id);
									$dataSubjek = $subject->ts_id;

//$con=mysqli_connect("localhost","live_tutorkami","Tutor@kami","tutorkami_db");
$sql2="SELECT * FROM tk_tutor_subject
WHERE trs_u_id = $user_id AND trs_ts_id = $dataSubjek";
$result2=mysqli_query($con,$sql2);
$sub_chk=mysqli_num_rows($result2);
							
							?>
                            <div class="col-md-12">  
                               <input type="checkbox" name="tutor_subject_<?php echo $course->tc_id;?>[<?php echo $i; ?>]" id="tutor_subject_<?php echo $course->tc_id;?>_<?php echo $i; ?>" value="<?php echo $subject->ts_id;?>" data-pid="<?php echo $course->tc_id;?>" data-cname="tutor_subject_" data-pname="tu_course_" onchange="check_parent(this)" <?php if($sub_chk > 0){echo 'checked';}//echo ($sub_chk->data > 0) ? 'checked' : '';?>> 
