...
//           });
   ...
   <body>
      ...
      <header class="navbar-fixed-top <?php echo (basename($_SERVER['PHP_SELF']) == 'tutor-login.php' || basename($_SERVER['PHP_SELF']) == 'parent_login.php' || basename($_SERVER['PHP_SELF']) == 'forget.php') ? 'hidden' : '' ;?>">
         <div class="container">
                     ...
                     <ul class="nav navbar-nav navbar-right off_dropd">
                       ...
                       <?php // Get Header Navigation
                        ...
                        <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
                          ...
                          <li>
                            <a href="http://tutorkami.com/tutor-login.php" class="title">Log Masuk Tutor</a>
                          </li> 
                        </ul>
                      </li>                           
