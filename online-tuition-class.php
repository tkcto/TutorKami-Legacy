...
$queryLevel2 = $conn->query("SELECT tc_id, tc_title FROM tk_tution_course WHERE tc_id !='9' ORDER BY tc_id ASC");
...
<html lang="en">
   <head>
	  ...
	  <title><?PHP echo str_replace(","," ",str_replace(",,",",",$seoSub)).' '.str_replace(","," ",str_replace(",,"," ",$seoLevel)); ?> Online Tutors For Online Tuition & Class</title>
	  <meta name="description" content="We help you get a <?PHP echo str_replace(","," ",str_replace(",,",",",$seoSub)).' '.str_replace(","," ",str_replace(",,"," ",$seoLevel)); ?> online tutor easier, safer & with a guarantee" />
		                ...
		                <div class="card wizard-card" data-color="red" id="wizardProfile">
		                        	...
		                        	<h1 class="wizard-title textH1" id="search-term">
		                        	   <p><font color="#14114e" style=""><strong>
		                        	       <?PHP echo str_replace(","," ",str_replace(",,",",",$seoSub)).' '.str_replace(","," ",str_replace(",,"," ",$seoLevel)); ?> Online Tutors For Online Tuition & Class
		                        	   </strong></font></p>
									</h1>
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <p class="control-label textH3" style="text-align: center;font-family: system-ui;">
                                                    We help you get a <?PHP echo str_replace(","," ",str_replace(",,",",",$seoSub)).' '.str_replace(","," ",str_replace(",,"," ",$seoLevel)); ?> online tutor easier, safer & with a guarantee
                                                </p>
											</div>
                                        </div>
...
<br/>
		                    	...
		                    	<div class="wizard-header">
		                        	...
		                        	<h2 class="wizard-title textH2" id="search-term">
									   <p><font color="#14114e" style=""><strong>WHY CHOOSE ONLINE TUITION OR ONLINE TUTORING?</strong></font></p>
		                        	</h2><br/>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-10">
                                                <p class="control-label textH3" style="text-align: left;font-family: system-ui;">Lessons can be conducted anywhere (preferably with a strong internet connection)</p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-2">
                                            ...
                                            <div class="col-xs-10">
                                                <p class="control-label textH3" style="text-align: left;font-family: system-ui;">Lessons are tailored to meet student's needs</p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-2">
                                            ...
                                            <div class="col-xs-10">
                                                <p class="control-label textH3" style="text-align: left;font-family: system-ui;">No physical interaction, social distancing are ensured</p>
                                            </div>
                                        </div>
		                        	   ...
		                        	   <p><font color="#14114e" style=""><strong>WHY CHOOSE TUTORKAMI</strong></font></p>
                                        ...
                                        <div class="row"><br/>
                                            <div class="col-xs-12">
                                                ...
                                                <p class="control-label textH3" style="text-align: center;font-family: system-ui;">We have a process and a system in vetting our shortlisted tutors, to ensure you will get quality tutors</p>
                                            </div>
                                        </div><br/><br/><br/>
                                        <div class="row">
                                            <div class="col-xs-12">
                                                ...
                                                <p class="control-label textH3" style="text-align: center;font-family: system-ui;">Tutors are required to complete all lessons agreed before payment is released to them. This will prevent cases of tutor asking payment upfront, and did not conduct the lessons afterwards</p>
                                            </div>
                                        </div><br/><br/><br/>
                                        <div class="row">
                                            <div class="col-xs-12">
                                                ...
                                                <p class="control-label textH3" style="text-align: center;font-family: system-ui;">Established in 2013, TutorKami.com has more than 6 years of experience in helping parents and students to get tutors, all over Malaysia</p>
                                            </div>
                                        </div>
		                    	</div>
		                    	<br/>
		                    	<div class="wizard-header">
		                    	    <img alt="" class="img-responsive center-block" src="folder-tuisyen-online/red-line.PNG"  /><br/>
		                        	<h2 class="wizard-title textH2" id="search-term">
		                        	   <p><font color="#14114e" style="text-transform: uppercase;"><strong>Get instant quotation for online tutoring service</strong></font></p>
		                        	</h2><br/>
		                    	</div>
      ...
      <div class="row" style="text-align: left;">
         ...
         <div class="col-md-offset-2 col-md-8" id="wizardProfile" style="margin-top:-60px;">
            ...
            <form method="post" id="filter_user">
               ...
               <div class="row">
                  <div class="col-md-3"><span class="org-txt "><strong><font size='3'>Level & Subject :</font></strong></span></div>
                  <div class="col-md-9">
                     <div class="form-group">
						<?php	
							$levelSelected = "";
                     ...
                     <div class="form-group">
                        <div class="levelShowHide" style="display: none;">
                           <div class="dropbox">Please Select Subject</div>
                           <div class="dropPop">
                              <div class="row">
               ...
               <div class="row">
				...
				?>
                  <div class="col-md-3"><span class="org-txt "><strong><font size='3'>Gender :</font></strong></span></div>
                  <div class="col-md-3">
               ...
               <div class="row">
				  ...
				  ?>
                  <div class="col-md-3"><span class="org-txt"><strong><font size='3'>Conduct Online Tuition :</font></strong></span></div>
                  <div class="col-md-3">
                     <select class="form-control" name="ConductOnline" id="ConductOnline" onchange="getConductOnline(this.value)">
                        <option value="" >All</option>
                        <option value="Yes" <?php if( $ConductOnlineSelected != '' && $ConductOnlineSelected == 'Yes' ){ echo 'selected'; }else if( $ConductOnlineSelected == '' ){  echo 'selected'; } ?> ><?php echo YES; ?></option>
                        <!--<option value="No"  <?php //if( $ConductOnlineSelected != '' && $ConductOnlineSelected == 'No' ){ echo 'selected'; } ?> ><?php //echo NO; ?></option>-->
                     </select>
                  </div>
               </div>
               ...
               <div class="row">
                  <div class=" col-sm-12 col-md-12 search-tb" id="submitsearch" align="center">
                     <br>
                     <button type="button" name="submitBtn" onclick="pretest()" class="btn btn-orange btn-lg">Search</button>
                  </div>
               </div>
            </form>
<br/><br/>
...
if($currentData2 != ''){
                ...
                $sqlFilterLevel = " SELECT * FROM tk_tution_course WHERE tc_title IN ('".$arrayState."') ";                 
                ...
                if($resultFilterLevel->num_rows > 0){ 
                    ...
                    $getThisLevel2 = $rowFilterLevel['tc_title'];
                }else{
                    $getThisLevel = '';
                }

                $sqlFilterSubject = " SELECT * FROM tk_tution_subject WHERE ts_tc_id ='".$getThisLevel."' AND ts_title IN ('".$arrayState."') ";                 
                ...
                if($resultFilterSubject->num_rows > 0){ 
                    ...
                    $getThisSubject2 = $rowFilterSubject['ts_title'];
                }else{
                    $getThisSubject = '';
                }
...
if( isset($_SESSION['ConductOnline']) && $_SESSION['ConductOnline'] != "" ){
    if( $_SESSION['ConductOnline'] == 'Yes' ){
        $queryConductOnline = " AND conduct_online = '".$_SESSION['ConductOnline']."' AND conduct_online_text != '' ";
    }else{
    ...
    $queryConductOnline = " AND conduct_online = '".$_SESSION['ConductOnline']."' AND conduct_online_text != '' ";
                    ...
                    WHERE u_status = 'A' AND u_role = '3' AND conduct_online = 'Yes' AND conduct_online_text != '' $queryJantina "; 
                                                     ...
                                                     <div class="col-md-3 col-sm-3">
                                                         <div class="card-container">
                                                            <div class="card">
                                                                ...
                                                                <div class="back">
                                                                    <div class="header">
                                                                        <h5 class="motto"><a href="tutor_profile.php?did=<?php echo $rowShowResult['u_displayid']; ?>" target="_blank" class="btn btn-info">View <?=$rowShowResult['u_displayname']?></a></h5>
                                                                    </div>
                                                                    <div class="content">
                                                                        <div class="main">
