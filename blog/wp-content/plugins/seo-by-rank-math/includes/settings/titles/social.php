...
$cmb->add_field( array(
	...
	'desc' => sprintf( esc_html__( 'Enter %s. Use a comma to separate multiple IDs. Alternatively, you can enter an app ID below.', 'rank-math' ), '<a href="https://findmyfbid.com/?utm_campaign=MyThemeShop" target="_blank">numeric user ID</a>' ),
) );
...
$cmb->add_field( array(
	...
	'desc' => sprintf( esc_html__( 'Enter %s. Alternatively, you can enter a user ID above.', 'rank-math' ), '<a href="https://developers.facebook.com/apps?utm_campaign=MyThemeShop" target="_blank">numeric app ID</a>' ),
) );
...
$cmb->add_field( array(
	...
	'desc'       => sprintf( esc_html__( 'Enter alphanumeric secret ID. %s.', 'rank-math' ), '<a href="https://goldplugins.com/documentation/wp-social-pro-documentation/how-to-get-an-app-id-and-secret-key-from-facebook/?utm_campaign=MyThemeShop" target="_blank">Learn more</a>' ),
...
$cmb->add_field( array(
	...
	'desc' => sprintf( esc_html__( 'Enter full URL of your Google Places listing here. %s', 'rank-math' ), '<a href="https://developers.google.com/maps/documentation/urls/guide?utm_campaign=MyThemeShop" target="_blank">How to find it?</a>' ),
) );
...
$cmb->add_field( array(
	...
	'desc' => wp_kses_post( __( 'Enter your domain\'s Reddit URL here. eg:', 'rank-math' ) ) .
		'<br><code>' . htmlspecialchars( 'https://www.reddit.com/domain/mythemeshop.com/' ) . '</code>',
) );
