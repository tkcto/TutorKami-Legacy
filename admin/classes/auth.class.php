...
class auth extends db
{
        ...
        if ($username <> '' && $password <> '') {
            ...
            if ($resUser->num_rows > 0) {
                ...
                if ($arrUser['u_status'] == 'A' && $arrUser['r_status'] == 'A') {
                    ...
                    // Log Activity
                    Log::ActivityLog(55, $arrUser['u_id'], 'Login', date('Y-m-d H:i:s'));
    ...
    function Logout() {
        Log::ActivityLog(56, $_SESSION[DB_PREFIX]['u_id'], 'Logging out', date('Y-m-d H:i:s'));
        ...
        $this->db->query($updateLastActivity);
