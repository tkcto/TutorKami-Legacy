...
<html lang="en">
   <head>
	  ...
	  <title>Tutorkami : Cari Guru Tuisyen, Cikgu Tuisyen di Rumah, Malaysia</title>
	  <meta name="description" content="Dapatkan guru tuisyen di rumah yang berkualiti untuk anak anda. Lebih 1,000 pilihan cikgu tuisyen untuk anda, bermula dari RM45 / jam." />
	  <meta name="keywords" content="tutor rumah, tuisyen rumah, tuisyen rumah, tuisyen rumah, belajar di rumah, tutor swasta, guru swasta, guru tuisyen" />
	  <!-- add icon link 
	  <link rel="icon" href="https://www.tutorkami.com/admin/img/favicons/apple-icon-180x180.png" type="image/x-icon"> -->

<!-- Google / Search Engine Tags -->
<meta itemprop="name" content="Tutorkami : Cari Guru Tuisyen, Cikgu Tuisyen di Rumah, Malaysia">
<meta itemprop="description" content="Dapatkan guru tuisyen di rumah yang berkualiti untuk anak anda. Lebih 1,000 pilihan cikgu tuisyen untuk anda, bermula dari RM45 / jam.">
<meta itemprop="image" content="https://www.tutorkami.com/images/header-min.jpg">

<!-- Facebook Meta Tags -->
<meta property="og:url" content="https://www.tutorkami.com/">
<meta property="og:type" content="website">
<meta property="og:title" content="Tutorkami : Cari Guru Tuisyen, Cikgu Tuisyen di Rumah, Malaysia">
<meta property="og:description" content="Dapatkan guru tuisyen di rumah yang berkualiti untuk anak anda. Lebih 1,000 pilihan cikgu tuisyen untuk anda, bermula dari RM45 / jam.">
<meta property="og:image" content="https://www.tutorkami.com/images/header-min.jpg">

<!-- Twitter Meta Tags -->
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="Tutorkami : Cari Guru Tuisyen, Cikgu Tuisyen di Rumah, Malaysia">
<meta name="twitter:description" content="Dapatkan guru tuisyen di rumah yang berkualiti untuk anak anda. Lebih 1,000 pilihan cikgu tuisyen untuk anda, bermula dari RM45 / jam.">
<meta name="twitter:image" content="https://www.tutorkami.com/images/header-min.jpg">
...
<!--		
    <div class="hidden-md hidden-sm hidden-xs pull-right" style="padding-left:15px;">
      <a href="request_a_tutor.php" style="margin-top:40px;margin-right:0px;" type="button" class="btn btn-info navbar-sm">DAPATKAN TUTOR</a>
  	</div>
...
?>
	<div class="hidden-lg hidden-md hidden-xs pull-right">
      <a href="request_a_tutor.php" style="margin-top:-60px;margin-right:85px;" type="button" class="btn btn-info navbar-sm">DAPATKAN TUTOR</a>
  	</div>
    <div class="hidden-lg hidden-md hidden-sm pull-right">
      <a href="request_a_tutor.php" style="margin-top:-40px;margin-right:40px;" type="button" class="btn btn-info navbar-xs">DAPATKAN TUTOR</a>
  	</div>
<?php
}else{
?>
	<div class="hidden-lg hidden-md hidden-xs pull-right">
      <a href="request_a_tutor.php" style="margin-top:-110px;margin-right:85px;" type="button" class="btn btn-info navbar-sm">DAPATKAN TUTOR</a>
  	</div>
    <div class="hidden-lg hidden-md hidden-sm pull-right">
      <a href="request_a_tutor.php" style="margin-top:-80px;margin-right:40px;" type="button" class="btn btn-info navbar-xs">DAPATKAN TUTOR</a>
  	</div>
<?php
}
?>
          ...
          <ul class="nav navbar-nav navbar-right off_dropd" id="shadow2">
                       <?php if(!isset($_SESSION['auth'])) { ?>
                        ...
                        <li class="dropdown text-right">
							...
							<ul class="dropdown-menu text-right" role="menu">
								...
								<li class="sizedcreenli"><a href="https://www.tutorkami.com/my/client_login">Log Masuk</a></li>
							</ul>
                        </li>
                       ...
                       <?php } else { ?>
                        ...
                        <li class="dropdown text-right" id="shadow">
                           ...
                           <ul class="dropdown-menu text-right" role="menu">
                              <li class="sizedcreenli"><a href="clients_profile.php" class="language">Profil Saya</a></li>
                              <li class="sizedcreenli"><a href="my-classes.php" class="language">Senarai Kelas</a></li>
                              <!--<li class="sizedcreenli"><a href="payment_history.php" class="language">Rekod Bayaran</a></li>-->
                              <li class="sizedcreenli"><a href="parent_guide.php" class="language">Panduan Ibubapa</a></li>
							  ...
							  <li class="sizedcreenli"><a href="logout.php" class="language">Log Keluar</a></li>
                        ...
                        <li class="dropdown text-right" id="shadow">
                           <a href="#"class="dropdown-toggle text-right" data-toggle="dropdown" role="button">
                           Selamat Datang <?php echo ucwords($_SESSION['auth']['display_name']); ?> <span class="caret"></span></a>
                           <ul class="dropdown-menu text-right" role="menu">
                              <li class="sizedcreenli"><a href="edit_account.php" class="language">Kemaskini Akaun</a></li>
                              <!--<li class="sizedcreenli"><a href="change_password.php" class="language">Tukar Kata Laluan</a></li>-->
                              <li class="sizedcreenli"><a href="view_profile.php" class="language">Lihat Profil</a></li>
                              <li class="sizedcreenli"><a href="my-classes.php" class="language">Senarai Kelas</a></li>
                              <!--<li class="sizedcreenli"><a href="tutor_payment_history.php" class="language">Rekod Bayaran</a></li>-->
                              <li class="sizedcreenli"><a href="search_job.php" class="language">Job Terkini</a></li>
                              <li class="sizedcreenli"><a href="tutor_guide.php" class="language">Panduan Tutor</a></li>
   ...
   <article class="banner_text">
      ...
      <div class="container">
         ...
         <div class="row">
            ...
            <!--<h1>Cara yang lebih baik untuk mendapatkan tutor berkualiti dengan jaminan kami *</span></h1>
                        ...
                        <div class="row ro1">
								...
								<div class="col-40">
										  ...
										  <div class="input-group ui-widget" style="">
											 ...
											 <input type="text" id="location" name="location" class="my_form_control ui-autocomplete-input customInput" id="location" placeholder="Your location" />
										  </div>
								...
								<div class="col-20">
										<div>
											...
											<button type="submit" class="btn btn-md search_btn" style="width:100%;">Cari Tutor</button>
										</div>
								</div>
                        </div>
...
<div class="card" style="background-color:#f1592a">
  <div class="card-body">
    <h1 style="margin-top:32%;padding:5px;"> Tutor berkualiti dapat membantu pelajar mencapai kemajuan berterusan dalam pelajaran</span></h1>
  </div>
</div>
      ...
      <div class="carousel-inner" role="listbox">
         ...
         <div class="item  active ">
			<?php if(stristr($_SERVER['HTTP_USER_AGENT'], "Mobile")){ // if mobile browser ?>
				<img src="images/header-min.jpg">
			<?php }else { // desktop browser ?>
				<img src="images/header-min.jpg" style="padding-top: 80px;">
			<?php } ?>
                        ...
                        <div class="row ro1">
								...
								<div class="col-20">
										<div>
											...
											<button type="submit" class="btn btn-md search_btn border-radius" style="width:100%;">Cari Tutor</button>
										</div>
								</div>
                        </div>
   ...
   <div class="col-md-2"></div>
       ...
       <div class=" col-md-12 tutor_button">
			...
			<div class="row  b_margin_50">
					...
					<h2 class="header customH2">LANGKAH<span>&#178;</span> MENDAPATKAN TUTOR</h2>
	...
	<div class="hidden-lg hidden-md hidden-sm media">
        ...
        <div class="media-body">
            <p class="media-heading orange_head" style="font-size:20px;">1. Beritahu Keperluan Anda</p>
            <p>Nyatakan maklumat tutor dan kelas tuisyen yang anda mahu dengan menekan butang 'Get A Tutor'</p>
        </div>
    </div>
	...
	<div class="hidden-lg hidden-md hidden-sm media">
        ...
        <div class="media-body">
            <p class="media-heading orange_head" style="font-size:20px;">2. Pilih tutor</p>
            <p>Profil tutor2 mengikut kemahuan anda akan dihantar untuk anda pilih siapa yang dirasakan sesuai</p>
        </div>
    </div>
	...
	<div class="hidden-lg hidden-md hidden-sm media">
        ...
        <div class="media-body">
            <p class="media-heading orange_head" style="font-size:20px;">3. Atur Sesi Pertama</p>
            <p>Hubungi tutor pilihan untuk mengatur jadual sesi kelas yang pertama</p>
        </div>
    </div>
	...
	<div class="hidden-lg hidden-md hidden-sm media">
        ...
        <div class="media-body">
            <p class="media-heading orange_head" style="font-size:20px;">4. Buat Bayaran</p>
            <p>Jika berpuas hati dengan tutor selepas sesi pertama, barulah buat bayaran kepada TutorKami</p>
        </div>
    </div>
</div>
...
<p class="orange_head">1. Beritahu Keperluan Anda</p>
...
<p class="orange_head">2. Pilih tutor <br/><br/> </p>
...
<p class="orange_head">3. Atur Sesi Pertama <br/><br/></p>
...
<p class="orange_head">4. Buat Bayaran <br/><br/></p>
   ...
   <div class="container">
      ...
      <div class="row  b_margin_50">
         ...
         <div class="col-md-12">
            ...
            <h2 class="header customH2">Kenapa pilih TutorKami?</h2>
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12 text-center hw_box"><img alt="" class="img-responsive center-block" src="images/kualiti.png" style="width:80px" />
<p style="font-size:20px;" class="blue_head">Kualiti</p>

<p>Kami mempunyai sistem dan proses pemilihan tutor yang dapat membantu anda mendapat cikgu tuisyen yang berkualiti</p>
</div>

<div class="col-md-3 col-sm-6 col-xs-12 text-center hw_box"><img alt="" class="img-responsive center-block" src="images/selamat.png" style="width:80px" />
<p style="font-size:20px;" class="blue_head">Selamat</p>

<p>Kami pastikan tutor melengkapkan semua sesi seperti yang dipersetujui. Ini akan mengelakkan berlakunya kes tutor tidak datang walaupun setelah menerima bayaran</p>
</div>

<div class="col-md-3 col-sm-6 col-xs-12 text-center hw_box"><img alt="" class="img-responsive center-block" src="images/3.png" style="width:80px" />
<p style="font-size:20px;" class="blue_head">Berpengalaman</p>

<p>Ditubuhkan pada 2013, TutorKami berpengalaman lebih dari 6 tahun membantu ibubapa mendapatkan tutor dan guru tuisyen hampir di seluruh Malaysia</p>
</div>
...
<p style="font-size:20px;" class="blue_head">Rekod Kelas</p>

<!--<p>Tutor dimestikan untuk membuat rekod akan semua kelas yang dibuat.&nbsp;Anda boleh melihat rekod kelas ini didalam sistem online kami, untuk memastikan semua kelas telah dibuat sebelum bayaran seterusnya dibuat.</p>-->
<p>Anda boleh periksa rekod kelas secara mudah di sistem online kami, untuk mengetahui status dan info setiap sesi kelas</p>
</div>

<p class="m_top_30 col-xs-12 text-center hw_box"><a class="orange_btn" href="https://www.tutorkami.com/my/parent_faq.php">Baca FAQ</a></p>
      </div>
   ...
   <div class="container">
      ...
      <div class="row">
         ...
         <div class="col-md-8 col-md-offset-2">
            ...
            <h2 class="header customH2">Jaminan Kami</h2><br/>

            <p><img alt="" class="img-responsive center-block" src="images/img_gurantee.png" style="width:200px" /></p>

<hr class="myhr" />
<p>Anda hanya mula membayar dari sesi pertama jika anda berpuas hati dengan khidmat tutor kami. Jika tidak, kami akan dapatkan tutor yang lain, dan sesi pertama dengan tutor sebelum itu adalah&nbsp;<a class="orange_link" href="#">percuma</a>!</p>
         </div>
   ...
   <div class="container">
      ...
      <div class="row">
         ...
         <div class="col-md-8 col-md-offset-2">
            ...
            <h2 class="header customH2">TUTOR DAN CIKGU TUISYEN TERKINI</h2>

            <p class="subHead">Klik untuk lihat profil guru tuisyen</p>
...
<div class="clearfix"></div>
            <p class="m_top_30"><a href="https://www.tutorkami.com/my/search-tutor.php" class="orange_btn">LIHAT LAGI SENARAI TUTOR</a></p>
...
<section class="how_works">
   <div class="container">
      <div class="row">
         <div class="col-md-12">
			<h2 class="header customH2">Testimoni Klien</h2><br/>
   ...
   <div class="container">
      ...
      <div class="row">
         ...
         <div class="col-md-12">
            ...
            <!--<h1><span>Anda seorang </span>tutor?</h1>-->
            <h2 class="header customJoinH2"><span>Anda seorang </span>tutor?</h2>

<h3>Platform kami boleh membantu anda mendapatkan job. Sertai kami sekarang.</h3>

<p class="m_top_30"><a class="orange_btn" href="https://www.tutorkami.com/my/register.php">SERTAI KAMI</a></p>
         </div>
...
<section class="how_works gray_bg">
   <div class="container">
      <div class="row">
         <div class="col-md-8 col-md-offset-2">
            <h2 class="header customH2">Disokong Oleh</h2>
   ...
   <div class="container">
      ...
      <div class="row">
         ...
         <div class="col-md-12" style="position:relative;">
            ...
            <!--<h1><span>Sebarang&nbsp;</span>pertanyaan?</h1>-->
            <h2 class="header customJoinH2"><span>Sebarang&nbsp;</span>pertanyaan?</h2>


<h3>Boleh hubungi kami dengan emel di&nbsp;contact@tutorkami.com</h3>

<p><a class="chat" href="#"><img alt="chat" src="images/icon_chat.png" /></a></p>
         </div>
...
$('.buttonOk').click(function(){
    window.location.href = "https://www.tutorkami.com/my/clients-terms";
}) 
