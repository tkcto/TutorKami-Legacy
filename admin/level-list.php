        ...
        <div class="col-lg-12">
         <div class="ibox float-e-margins localization">
          <div class="ibox-title">
           <h5>Levels</h5>
           <div class="el-right">
            <a href="level-add.php" class="btn btn-primary">Add New</a>
            ...
            <table class="footable table table-stripped toggle-arrow-tiny default no-paging footable-loaded dataTables-example" data-page-size="15">
             <thead>
              <tr>
               ...
               <th data-hide="phone" class="footable-visible footable-sortable">Tahap<span class="footable-sort-indicator"></span></th>
           ...
           <tbody>
            ...
            <tr class="footable-even" style="display: table-row;">
             ...
             <td class="footable-visible footable-last-column">
               <div class="btn-group">
                 <a href="level-add.php?crs=<?php echo $arrCourse['tc_id'];?>" class="gray-text"><button class="btn-white btn edt-btn btn-xs">Edit</button></a>
                 <a href="level-list.php?crsd=<?php echo $arrCourse['tc_id'];?>" class="gray-text"><button class="btn-white btn edt-btn btn-xs">Delete</button></a>              
               </div>
             </td>
           </tr>
           <?php } ?>
