					...
					<form class="form-horizontal">					
						<div style="margin-left:0px;">
							<div class="row" >
								<div class="col-xs-6">
									<div class="form-group">
										<h4 style="margin-left:13px;"><strong>FEES :</strong></h4>
									</div>
								</div>
								<div class="col-xs-6" style="text-align: right;">
									<div class="form-group">
										<h4 style="text-align: right;margin-right:13px;" id="monthlyFeeOutput" ><strong><?PHP echo "<strong> RM ".$MonthlyFee." / month</strong>"; ?></strong></h4>
									</div>
								</div>
							</div>
							<div class="row" style="text-align: right;">
								...
								<div class="col-xs-6">
									<p id="pricePerStudent"  style="color:blue;margin-left:0px;margin-bottom:10px;display:none;text-align: right;"><b><?PHP echo "(RM ".$pricePerStudent." / student)"; ?></b></p>		
								</div>
							</div>
						</div>	
						...
						<div class="row">
							...
							<div class="col-xs-4" style="margin-left:-23px;margin-top:-5px;">
								<input readonly style="text-align:center;width:110px;" type="text" id="normalTutorInput" class="form-control input-number" value="<?PHP echo "RM ".$thisRate." / hour"; ?>">
							</div>
							<div class="col-xs-2">
						...
						<div class="row">
							...
							<div class="col-xs-4" style="margin-left:-23px;margin-top:-5px;">
								<input readonly style="text-align:center;width:110px;" type="text" id="NoOfStudentsInput" name="NoOfStudentsInput" class="form-control input-number" value="<?PHP echo $_POST['person']." pax"; ?>" min="1" max="5" onChange="NoOfStudentsOnChange()">
							</div>
							<div class="col-xs-2" style="margin-left:0px;">
								<span class="input-group-btn">
									<button style="color:white;" type="button" class="btn btn-default btn-number btn-xs" data-type="minus" data-field="NoOfStudentsInput">
										<span class="glyphicon glyphicon-minus" style="font-size:18px;width:18px;"></span>
									</button>
								</span>
								<span class="input-group-btn">
									<button style="color:white;" type="button" class="btn btn-default btn-number btn-xs" data-type="plus" data-field="NoOfStudentsInput">
										<span class="glyphicon glyphicon-plus" style="font-size:18px;width:18px;"></span>
									</button>
								</span>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-xs-4" style="margin-left:-23px;margin-top:-5px;">
								<input readonly style="text-align:left;width:110px;" type="text" id="sessionDuration" name="sessionDuration" class="form-control input-number" value="<?PHP echo "1 hour 30 mins"; ?>">
							</div>
							<div class="col-xs-2" style="margin-left:0px;">
								<span class="input-group-btn">
									<button style="color:white;" type="button" class="btn btn-default btn-number btn-xs" data-type="minus" data-field="sessionDuration">
										<span class="glyphicon glyphicon-minus" style="font-size:18px;width:18px;"></span>
									</button>
								</span>
								<span class="input-group-btn">
									<button style="color:white;" type="button" class="btn btn-default btn-number btn-xs" data-type="plus" data-field="sessionDuration">
										<span class="glyphicon glyphicon-plus" style="font-size:18px;width:18px;"></span>
									</button>
								</span>
							</div>
						...
						<div class="row">
							...
							<div class="col-xs-4" style="margin-left:-23px;margin-top:-5px;">
								<input readonly style="text-align:center;width:110px;" type="text" id="sessionPerMonth" name="sessionPerMonth" class="form-control input-number" value="<?PHP echo "4 session"; ?>" min="4" max="16" >
							</div>
							<div class="col-xs-2" style="margin-left:0px;">
								<span class="input-group-btn">
									<button style="color:white;" type="button" class="btn btn-default btn-number btn-xs" data-type="minus" data-field="sessionPerMonth">
										<span class="glyphicon glyphicon-minus" style="font-size:18px;width:18px;"></span>
									</button>
								</span>
								<span class="input-group-btn">
									<button style="color:white;" type="button" class="btn btn-default btn-number btn-xs" data-type="plus" data-field="sessionPerMonth">
										<span class="glyphicon glyphicon-plus" style="font-size:18px;width:18px;"></span>
									</button>
								</span>
							</div>
...
<hr>
						...
						<div class="row">
							<div class="col-xs-8">Registration Fees (RM50/student, one-time)</div>
							<div class="col-xs-4">
...
<hr>
					...
					<button type="button" class="btn btn-previous btn-fill btn-danger btn-wd" onClick="btnPrevious()">Previous</button>
...
function loadDiscount() {
	...
	var state  = "<?php echo $thisState; ?>";
    var city   = "<?php echo $thisCity; ?>";
