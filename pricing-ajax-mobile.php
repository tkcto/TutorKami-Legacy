...
if( $_SERVER['HTTP_REFERER'] == 'https://www.tutorkami.com/price' ){
	...
	$pageStyle5 = 'class="text-left" style="width:150px;color:blue;margin-left:-14px;margin-bottom:10px;display:none;"';
	...
	$pageStyle9 = '';
	$pageStyle10 = 'style="text-align:left;width:93px;"';
	$pageStyle11 = 'style="font-size:18px;width:8px;"';
	$pageStyle12 = '';
	$pageStyle13 = '';
	$pageStyleSpace = '';
}else{
	$pageStyle0 = 'style="margin-top: 25px;text-align: left;"';
	...
	$pageStyle5 = 'style="color:blue;margin-left:0px;margin-bottom:10px;display:none;text-align: right;"';
					...
					<form class="form-horizontal">					
						<div <?PHP echo $pageStyle1; ?>>
							<div class="row">
								<div class="col-xs-6">
									<div class="form-group">
										<h4 <?PHP echo $pageStyle2; ?> ><strong>FEES :</strong></h4>
									</div>
								</div>
								<div class="col-xs-6" <?PHP echo $pageStyle3; ?>>
									<div class="form-group">
										<h4 <?PHP echo $pageStyle4; ?> id="monthlyFeeOutput" ><strong><?PHP echo "<strong> RM ".$MonthlyFee." / month</strong>"; ?></strong></h4>
									</div>
								</div>
							</div>
							<div class="row" <?PHP echo $pageStyle3; ?>>
								...
								<div class="col-xs-6">
									<p id="pricePerStudent" <?PHP echo $pageStyle5; ?>><b><?PHP echo "(RM ".$pricePerStudent." / student)"; ?></b></p>		
								</div>
							</div>
						</div>	
						...
						<div class="row">
							...
							<div class="col-xs-2">
								...
								<span class="input-group-btn">
									<label class="switch" style="margin-top:10px;<?PHP echo $pageStyle13;?>">
						...
						<div class="row">
							...
							<div class="col-xs-4" <?PHP echo $pageStyle6; ?>>
								<input readonly <?PHP echo $pageStyle7; ?> type="text" id="normalTutorInput" class="form-control input-number" value="<?PHP echo "RM ".$thisRate." / hour"; ?>">
							</div>
							<div class="col-xs-2">
								<span class="input-group-btn">
									<label></label>
						...
						<div class="row">
							...
							<div class="col-xs-4" <?PHP echo $pageStyle6; ?>>
								<input readonly <?PHP echo $pageStyle7; ?> type="text" id="NoOfStudentsInput" name="NoOfStudentsInput" class="form-control input-number" value="<?PHP echo $_POST['person'];//echo $_POST['person']." pax"; ?>" min="1" max="5" onChange="NoOfStudentsOnChange()">
							</div>
						...
						<div class="row">
							...
							<div class="col-xs-4" <?PHP echo $pageStyle6; ?>>
								<input readonly <?PHP echo $pageStyle10; ?> type="text" id="sessionDuration" name="sessionDuration" class="form-control input-number" value="<?PHP echo "1 hour 30 mins"; ?>">
							</div>
							<div class="col-xs-2" <?PHP echo $pageStyle8; ?>>
								<span class="input-group-btn">
						...
						<div class="row">
							...
							<div class="col-xs-4" <?PHP echo $pageStyle6; ?>>
								<input readonly <?PHP echo $pageStyle7; ?> type="text" id="sessionPerMonth" name="sessionPerMonth" class="form-control input-number" value="<?PHP echo "4 sessions"; ?>" min="4" max="16" >
							</div>
							<div class="col-xs-2" <?PHP echo $pageStyle8; ?>>
								<span class="input-group-btn">
...
<hr>
						...
						<div class="form-group">
							<h4 class=" col-xs-6"><strong><?PHP echo $pageStyleSpace.$pageStyleSpace; ?>TOTAL :</strong></h4>
							<div class="col-xs-6">
							...
							<h4 class=" col-xs-8" style="margin-top:-1px;"><font style="font-size:13px;"><?PHP echo $pageStyleSpace.$pageStyleSpace.$pageStyleSpace; ?><?PHP if( $_POST['state'] == 'Online Tuition' ){echo $thisLevel.' for Online Tuition';}else{echo $thisLevel.' in '.$thisCityName.', '.$thisStateName;} ?></font></h4>
							<div class="col-xs-4">
								<p style="text-align: right;font-size:10px;font-style: oblique;margin-top:0px;" id="strikethrough" class="hidden"><del>RM <?PHP echo $Total; ?></del></p>
								<p style="text-align: right;font-size:10px;font-style: oblique;margin-top:0px;">*for the 1st month</p>
							</div>
