		                ...
		                <!--        You can switch " data-color="purple" "  with one of the next bright colors: "green", "orange", "red", "blue"       -->
		                        ...
		                        <div class="tab-content">
		                                	...
		                                	<div class="col-sm-12">
												...
												<div class="form-group label-floating">
	                                        		...
	                                        		<select class="form-control" id="selectCities" name="selectCities">
														<!--<option value="dummySelect">Select State First</option>-->
														<option disabled="" selected=""></option>
		                                        	</select>
		                                    	</div>
												<div class="form-group label-floating">
		                            ...
		                            <!--<div class="tab-pane" id="account">
		                                <h4 class="info-text"> Please Select Total Student </h4>
		                                <div class="row">
		                                    <div class="col-sm-10 col-sm-offset-1">
		                                        <div class="col-sm-3">
		                                            <div class="choice" data-toggle="wizard-checkbox" rel="tooltip" title="One ( 1 ) Student">
		                                        ...
		                                        <div class="col-sm-3">
		                                            <div class="choice" data-toggle="wizard-checkbox" rel="tooltip" title="Two ( 2 ) Student">
		                                        ...
		                                        <div class="col-sm-3">
		                                            <div class="choice" data-toggle="wizard-checkbox" rel="tooltip" title="Three ( 3 ) Student">
		                                        ...
		                                        <div class="col-sm-3">
		                                            <div class="choice" data-toggle="wizard-checkbox" rel="tooltip" title="Four ( 1 ) Student">
		                                                <input type="checkbox" name="jobb" value="Design">
		                                                <div class="icon">
		                                                    <i class="fa">&#x34;</i>
		                                                </div>
...
Open maximized popup
</button>-->
	                        	<div class="wizard-footer">
	                            	<div class="pull-right">
	                                    <input type='button' class='btn btn-next btn-fill btn-success btn-wd' name='next' value='Next' onClick="myFunction()"/>
	                                    <input type='button' class='btn btn-finish btn-fill btn-danger btn-wd' name='finish' value='Close' onClick="closeWindow()" />
	                                </div>
	                                <div class="pull-left">
