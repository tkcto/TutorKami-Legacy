...
?>	
	...
	<div id="content1" class="collapse in"><br/><br/>
		...
		<button id="thisno1" type="button" class="btn btn-success btn-outline">Terms of Accepting 1-to-1 Tuition Job</button> 
		<button id="thisno2" type="button" class="btn btn-success btn-outline">Additional terms : Group Tuition</button>
