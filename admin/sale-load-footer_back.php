...
if(isset($_POST['dataFooter'])){
    ...
    if ($resultSelect->num_rows > 0) {
        ...
        <tr style="background-color: white;">
            ...
            <?PHP
            /*
                $sqlSum = " SELECT SUM(no9) as total FROM tk_sales_sub WHERE main_id = '".$dataFooter['mainID']."' AND tab_name = '".$dataFooter['tab']."' AND month = '".$dataFooter['month']."' AND row_no != '0' ";
                $resultSum = $conn->query($sqlSum);
                if ($resultSum->num_rows > 0) {
                    while($rowSum = $resultSum->fetch_assoc()){
                        //echo number_format((float)$rowSum['total'], 2, '.', '');  
            ...
            ?>
                                  <?PHP  
                                    ...
                                    /*
                                    $sqlSum = " SELECT SUM(no4) as total FROM tk_sales_sub WHERE main_id = '".$dataFooter['mainID']."' AND tab_name = '".$dataFooter['tab']."' AND month = '".$dataFooter['month']."' AND no3 = 'R.F' AND row_no != '0' ";
                                    $resultSum = $conn->query($sqlSum);
                                    if ($resultSum->num_rows > 0) {
                                        while($rowSum = $resultSum->fetch_assoc()){
