...
$cmb->add_field( array(
	...
	'desc'    => sprintf( wp_kses_post( __( 'Remove /category/ from category archive URLs. %s <br>E.g. <code>example.com/category/my-category/</code> becomes <code>example.com/my-category</code>', 'rank-math' ) ), '<a href="https://mythemeshop.com/kb/wordpress-seo-plugin-rank-math/how-to-setup/#strip-category-base" target="_blank">' . esc_html__( 'Why do this?', 'rank-math' ) . '</a>' ),
	'default' => 'off',
) );
