...
<?php require_once('mobile-detect/mobile-detect.php'); ?>
<html lang="en">
   <head>
      <meta charset="utf-8">
	  ...
	  <meta name="description" content="Tutorkami is Malaysia's trusted and affordable home tutor & home tuition site. We offer the best service with a guarantee to our customers." />
...
<meta itemprop="name" content="TutorKami : Search for Home Tutor, Home Tuition & Tuisyen in Malaysia">
<meta itemprop="description" content="Tutorkami is Malaysia's trusted and affordable home tutor & home tuition site. We offer the best service with a guarantee to our customers.">
...
<meta property="og:title" content="TutorKami : Search for Home Tutor, Home Tuition & Tuisyen in Malaysia">
<meta property="og:description" content="Tutorkami is Malaysia's trusted and affordable home tutor & home tuition site. We offer the best service with a guarantee to our customers.">
<meta property="og:image" content="https://www.tutorkami.com/images/Slider1920x1000.jpg">

<!-- Twitter Meta Tags -->
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="TutorKami : Search for Home Tutor, Home Tuition & Tuisyen in Malaysia">
<meta name="twitter:description" content="Tutorkami is Malaysia's trusted and affordable home tutor & home tuition site. We offer the best service with a guarantee to our customers.">
...
<!-- view-source:https://getbootstrap.com/docs/3.4/examples/navbar-fixed-top/ -->
...
https://www.google.com/search?biw=1920&bih=937&ei=dHagXe6TKcv6vASu7ZzABA&q=toggle+button+bootstrap+with+label&oq=toggle+button+bootstrap+with+&gs_l=psy-ab.3.1.0j0i22i30l9.32650.32650..41700...0.3..0.54.54.1......0....1..gws-wiz.......0i71.8xFvZZJC3iE
https://stackoverflow.com/questions/32312522/bootstrap-navigation-collapsing-and-extra-button
https://jsfiddle.net/mwatz122/udo21wo9/2/
https://getbootstrap.com/docs/3.4/examples/navbar-fixed-top/
view-source:https://getbootstrap.com/docs/3.4/examples/navbar-fixed-top/
https://getbootstrap.com/docs/3.4/customize/#labels
...
/* Medium devices (landscape tablets, 970px and down) */
...
if ($tablet_browser > 0) {
   ...
   //print 'is mobile';
   //echo '<a href="request_a_tutor.php" style="margin-top:25px;margin-right:10px;" type="button" class="pull-right btn btn-info navbar-sm">GET A TUTOR 2</a>';
}
else {
   //print 'is desktop';
}
		  ...
		  <?php if(!isset($_SESSION['auth'])) { ?>
						<li class="dropdown text-right">
							...
							<ul class="dropdown-menu text-right" role="menu">
								<li class="text-right"><a href="https://www.tutorkami.com/index">Home Page</a></li>
								<li class="text-right"><a href="https://www.tutorkami.com/about">About Us</a></li>
								<li class="text-right"><a href="https://www.tutorkami.com/contact-us">Contact Us</a></li>
							</ul>
						</li>
                        <li class="dropdown  text-right">
							<a href="#" class="dropdown-toggle text-right" data-toggle="dropdown" role="button">Parents <span class="caret"></span></a>
							<ul class="dropdown-menu text-right" role="menu">
								<li class="text-right"><a href="https://www.tutorkami.com/search_tutor">Search Tutor</a></li>
								<li class="text-right"><a href="https://www.tutorkami.com/parent_faq">FAQs</a></li>
								<li class="text-right"><a href="https://www.tutorkami.com/request_a_tutor?tutor_id=i3be8gz">Contact Us</a></li>
							</ul>
                        </li>
                        <li class="dropdown  text-right">
							<a href="#" class="dropdown-toggle text-right" data-toggle="dropdown" role="button">I'm a Tutor<span class="caret"></span></a>
							<ul class="dropdown-menu text-right" role="menu">
								<li class="text-right"><a href="https://www.tutorkami.com/tutor.php">Tutor’s Page</a></li>
								<li class="text-right"><a href="https://www.tutorkami.com/search_job.php">Latest Jobs</a></li>
								<li class="text-right"><a href="https://www.tutorkami.com/register.php">Register</a></li>
								<li class="text-right"><a href="https://www.tutorkami.com/tutor_faq.php">FAQs</a></li>
								<li class="text-right"><a href="https://www.tutorkami.com/login.php">Log In</a></li>
							</ul>
                        </li>
		  <?php }else{
					   ...
					   if($_SESSION['auth']['user_role'] == '4') { ?>
                        <li class="dropdown text-right">
                           <a href="#" class="dropdown-toggle text-right" data-toggle="dropdown" role="button">Welcome <?php echo ucfirst($_SESSION['auth']['first_name']); ?> <span class="caret"></span></a>
                           <ul class="dropdown-menu text-right" role="menu">
                              <li class="text-right"><a href="clients_profile.php" class="language">My Profile</a></li>
                              <li class="text-right"><a href="list_of_classes.php" class="language">List Of Classes</a></li>
                              <li class="text-right"><a href="payment_history.php" class="language">Payment History</a></li>
                              <li class="text-right"><a href="parent_guide.php" class="language">Parent's Guide</a></li>
							  <li class="text-right"><a href="clients-terms.php" class="language">Terms</a></li>
							  <li class="text-right"><a href="logout.php" class="language">Logout</a></li>
                           </ul>
                        </li>
                        <?php } else { ?>
                        <li class="dropdown text-right">
                           <a href="#" class="dropdown-toggle text-right" data-toggle="dropdown" role="button">Welcome <?php echo ucfirst($_SESSION['auth']['display_name']); ?> <span class="caret"></span></a>
                           <ul class="dropdown-menu text-right" role="menu">
                              ...
                              <li class="sizedcreenli"><a href="tutor_list_of_classes.php" class="language">List of Classes</a></li>
                              ...
                              <!--<li class="text-right"><a href="edit_account.php" class="language">Edit Account</a></li>
                              <li class="text-right"><a href="change_password.php" class="language">Change Password</a></li>
                              <li class="text-right"><a href="view_profile.php" class="language">View Profile</a></li>
                              <li class="text-right"><a href="tutor_list_of_classes.php" class="language">List of Classes</a></li>
                              <li class="text-right"><a href="tutor_payment_history.php" class="language">Payment History</a></li>
                              <li class="text-right"><a href="search_job.php" class="language">Latest Job</a></li>
                              <li class="text-right"><a href="tutor_guide.php" class="language">Tutor's Guide</a></li>
							  
							  <li class="text-right"><a href="tutors-terms.php" class="language">Terms</a></li>
    ...
    <nav class="navbar navbar-default navbar-fixed-top <?php echo (basename($_SERVER['PHP_SELF']) == 'login.php' || basename($_SERVER['PHP_SELF']) == 'parent_login.php' || basename($_SERVER['PHP_SELF']) == 'forget.php') ? 'hidden' : '' ;?>">
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <a style="margin-left:0.5px;" class="navbar-brand" href="index.php"><img src="images/logo.png" class="img-responsive" alt="tutorkami logo"/></a>
        </div>
        </div>
					   ...
					   if($_SESSION['auth']['user_role'] == '4') { ?>
                        <li class="dropdown">
                           ...
                           <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
                              <li><a href="clients_profile.php" class="language">My Profile</a></li>
                              <li><a href="list_of_classes.php" class="language">List Of Classes</a></li>
                              <li><a href="payment_history.php" class="language">Payment History</a></li>
                              <li><a href="parent_guide.php" class="language">Parent's Guide</a></li>
							  <li><a href="clients-terms.php" class="language">Terms</a></li>
							  <li><a href="logout.php" class="language">Logout</a></li>
                           </ul>
                        </li>
                        <?php } else { ?>
                        <li class="dropdown">
                           ...
                           <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
                              <li><a href="edit_account.php" class="language">Edit Account</a></li>
                              <li><a href="change_password.php" class="language">Change Password</a></li>
                              <li><a href="view_profile.php" class="language">View Profile</a></li>
                              <li><a href="tutor_list_of_classes.php" class="language">List of Classes</a></li>
                              <li><a href="tutor_payment_history.php" class="language">Payment History</a></li>
                              <li><a href="search_job.php" class="language">Latest Job</a></li>
                              <li><a href="tutor_guide.php" class="language">Tutor's Guide</a></li>
							  
							  <li><a href="tutors-terms.php" class="language">Terms</a></li>
   ...
   <div class="container">
      ...
      <div class="row">
         ...
         <div class="col-md-8 col-md-offset-2">
            ...
            <h1 class="header">LATEST HOME TUTORS</h1>
...
<h3>Contact us at the numbers below:</h3>
...
<p class="m_top_30"><a class="orange_btn" href="https://www.tutorkami.com/request_a_tutor?tutor_id=i3be8gz">Request a Tutor</a></p>
         </div>
