  ...
  background-color: #ffffff; 
      ...
      <div class="wrapper wrapper-content animated fadeInRight">
         <div class="row">
            ...
            <!--Preferred%20Time%20&%20Day%20-%20insert            -->
<?PHP
/*
echo $_GET['crt'];
    echo '<br/>';
 ...
 if($arrJb["j_create_date"] =='0000-00-00 00:00:00' || $arrJb["j_create_date"] ==''){
	...
	echo date("d/m/Y", strtotime($arrJb['j_create_date']));
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-lg-7">
                              <select class="form-control" name="j_jl_id">
                                ...
                                ?>
                                <option value="<?=$arrJobLvl['jlt_jl_id']?>" <?php if(isset($_GET['lvl'])) echo ($arrJobLvl['jlt_jl_id']==$_GET['lvl'])?'selected':''?>><?=$arrJobLvl['jlt_title']?></option>
                                <?php } ?>
                              </select>
                           </div>
                        </div>
                        <div class="form-group">
                           ...
                           <div class="col-lg-7">
                            <input type="text" class="form-control" name="jt_subject[en]" id="jt_subject" value="<?php echo isset($_GET['sbj']) ? $_GET['sbj'] : ''; ?>" required/> 
                           </div>
                        </div>
                        <div class="form-group">
                           <label class="col-lg-3 control-label" >Area :</label>
                           <div class="col-lg-7"><input type="text" class="form-control" name="j_area" id="j_area" value="<?php echo isset($_GET['ara']) ? $_GET['ara'] : ''; ?>" required> 
                           </div>
                        </div>
                        <div class="form-group">
                           ...
                           <div class="col-lg-4">
                              <select class="form-control" name="j_state_id" id="j_state_id" required>
                                 ...
                                 <option value="<?=$arrStates['st_id']?>" <?php if(isset($_GET['stt'])) echo ($arrStates['st_id']==$_GET['stt'])?'selected':''?>><?php echo $arrStates['st_name']?></option>
                                 <?php }?>
                              </select>
                           </div>
                            ...
                            <div class="col-lg-3">
                                <select class="form-control" name="newCity" id="newCity" required>
                                    ...
                                    <?php 
                                        ...
                                        $query = "SELECT * FROM tk_cities WHERE city_st_id='".$_GET['stt']."' ORDER BY city_name ASC"; 
                                        $result = $conDB->query($query); 
                                        if($result->num_rows > 0){ 
                                            while($row = $result->fetch_assoc()){
                                                ?><option value="<?php echo $row['city_id']; ?>" <?php if($row['city_id'] == $_GET['newCity']){echo 'selected';}?> ><?php echo $row['city_name']; ?></option><?php
                                            }?><option value="1384" <?php if('1384' == $_GET['newCity']){echo 'selected';}?> >Online Tuition</option><?php
                                        }
                                        //$dbCon->close();                               
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-lg-5"><input type="email" class="form-control" name="j_email" id="j_email" value="<?php echo isset($_GET['eml']) ? $_GET['eml'] : ''; ?>" required> 
                           </div>
                           <div class="col-lg-4">
                             <?php 
                             if (isset($_REQUEST['j'])) {
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-lg-7"><input type="text" class="form-control" name="j_telephone" id="j_telephone" value="<?php echo isset($_GET['tel']) ? $_GET['tel'] : ''; ?>" required> 
                           </div>
                        </div>
						
                        <div class="form-group">
                           <label class="col-lg-3 control-label">Lessons :</label>
                           <div class="col-lg-7"><input type="text" class="form-control" name="jt_lessons[en]" value="<?php echo isset($_GET['lss']) ? $_GET['lss'] : ''; ?>" required /> 
                           </div>
                        </div>
                        <div class="form-group">
                           ...
                           <div class="col-lg-7">
                                <div class="input-group">
                                    <input style="height:45px;" type="text" class="form-control" name="j_preferred_date_time" value="<?php echo isset($_GET['prd']) ? $_GET['prd'] : ''; ?>" required> 
                                    <span class="input-group-addon">
                                        <div class="checkbox">
                                            <label><input type="checkbox" id="j_check_timeday" name="j_check_timeday" <?php if ( $_GET['j_check_timeday'] == 'true') { echo "checked='checked'"; } ?> ><span class="cr" style="margin-left:-10px;"><i class="cr-icon glyphicon glyphicon-ok"></i></span></label>
                                        </div>
                                    </span>
                                </div>                           
                           </div>
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-lg-7"><input type="text" class="form-control" name="j_duration" value="<?php echo isset($_GET['drt']) ? $_GET['drt'] : ''; ?>" required> 
                           </div>
                        </div>
	...
	if($arrJb["j_deadline"] =='0000-00-00' || $arrJb["j_deadline"] ==''){
		...
		echo date("d-m-Y", strtotime($arrJb['j_deadline']));
                        ...
                        <!--<div class="form-group">
                           ...
                           <div class="col-lg-7"><input type="text" class="form-control" name="j_rate" value="<?php //echo isset($_GET['rte']) ? $_GET['rte'] : ''; ?>" required> 
                           </div>
                        </div>-->
                        <div class="form-group">
                           <label class="col-lg-3 control-label" >Tutor’s Rate :</label>
                           <div class="col-lg-7">
                                <div class="input-group">
                                    <input style="height:45px;" type="text" class="form-control" name="j_rate" value="<?php echo isset($_GET['rte']) ? $_GET['rte'] : ''; ?>" required> 
                                    <span class="input-group-addon">
                                        <div class="checkbox">
                                            <label><input type="checkbox" name="j_check_rate" <?php if ( $_GET['j_check_rate'] == 'true') { echo "checked='checked'"; } ?> ><span class="cr" style="margin-left:-10px;"><i class="cr-icon glyphicon glyphicon-ok"></i></span></label>
                                        </div>
                                    </span>
                                </div>                           
                           </div>
                        ...
                        <!--<div class="form-group">
                           <label class="col-lg-3 control-label">Preferred Time & Day:</label>
                           <div class="col-lg-7"><input type="text" class="form-control" name="j_preferred_date_time" value="<?php //echo isset($_GET['prd']) ? $_GET['prd'] : ''; ?>" required> 
                           </div>
                        </div>-->
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-lg-7"><input type="text" class="form-control" name="j_commission" value="<?php echo isset($_GET['cms']) ? $_GET['cms'] : ''; ?>" required> 
                           </div>
                        </div>
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-lg-7">
                              <textarea class="form-control" rows="5" name="jt_remarks[en]"><?php echo isset($_GET['rmk']) ? $_GET['rmk'] : ''; ?></textarea>
                           </div>
                        </div>
                        ...
                        <div class="form-group">
                           <label class="col-lg-3 control-label" >Parent’s Rate :</label>
                                <!--<div class="col-lg-7">
                                    <input type="text" class="form-control" name="parent_rate" value="<?php //echo isset($_GET['prt']) ? $_GET['prt'] : ''; ?>" > 
                                </div>
                                <div class="col-lg-7">
                                    <div class="form-inline">
                                        <input onkeypress="return isNumberKey(event)" type="text"  class="form-control" name="parent_rate" value="<?php //echo isset($_GET['prt']) ? $_GET['prt'] : ''; ?>" style="width:55px;" > <span> <font size="2">&nbsp;&nbsp;&nbsp;hour</font></span>
                                    </div>
                                </div>-->
                                
                               <div class="col-lg-7">
                                  <div class="form-inline">
                                  <input data-required onkeypress="return isNumberKey(event , this.id)" type="text"  class="form-control decimal" name="parent_rate" id="parent_rate" value="<?php echo isset($_GET['prt']) ? $_GET['prt'] : ''; ?>" style="width:70px;" > <span> <font size="2"></font></span><span> <font size="2"><b>&nbsp;&nbsp;per hour X&nbsp;&nbsp;</b></font></span>
                                  <input data-required onkeypress="return isNumberKey(event , this.id)" type="text"  class="form-control decimal" name="cycle" id="cycle" value="<?php echo isset($_GET['cycle']) ? $_GET['cycle'] : ''; ?>" style="width:70px;" > <span> <font size="2"><b>&nbsp;&nbsp;+&nbsp;&nbsp;</b></font></span>
                                  <input onkeypress="return isNumberKey(event , this.id)" type="text"  class="form-control decimal" name="rf" id="rf" value="<?php echo isset($_GET['rf']) ? $_GET['rf'] : ''; ?>" style="width:70px;" > <font size="2"><b>&nbsp;&nbsp;<span id='totalResult'></span>&nbsp;&nbsp;</b></font>
                                  </div>
                        ...
                        <!--<div class="form-group">
                           ...
                           <div class="col-lg-7">
                              <div class="form-inline">
                              <input onkeypress="return isNumberKey(event)" type="text"  class="form-control" name="cycle" id="cycle" value="<?php //echo isset($_GET['cycle']) ? $_GET['cycle'] : ''; ?>" style="width:50px;" > <span> <font size="2">&nbsp;&nbsp;&nbsp;hours</font></span>
                              </div>
						   </div>
                        </div>-->
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-lg-7">
                              <!--<textarea class="form-control" rows="5" id="jt_comments" name="jt_comments[en]"><?php //echo isset($_GET['cmm']) ? $_GET['cmm'] : ''; ?></textarea>-->
                              <textarea class="form-control" rows="5" id="jt_comments" name="jt_comments[en]"><?php if( isset($_SESSION["jt_comments"]) ){ echo $_SESSION["jt_comments"]; } ?></textarea>
                           </div>
                        </div>
