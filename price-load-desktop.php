...
if( !empty($_POST["level"]) && !empty($_POST["state"]) && !empty($_POST["person"]) ){
	...
	if( $_SERVER['HTTP_REFERER'] == 'https://www.tutorkami.com/price' || $_SERVER['HTTP_REFERER'] == 'https://www.tutorkami.com/my/harga-tuisyen-di-rumah-online' ){
		...
		$pageStyle0 = 'style="background-color:white;text-align: left;border-style: solid;border-bottom-color: black;"';
  ...
  Please insert discount code.
					...
					<form class="form-horizontal" <?PHP echo $pageStyle1; ?>>
						...
						<div class="form-group">
							<h4 class=" col-xs-6"><strong><?PHP echo $pageStyleSpace.$pageStyleSpace; echo $pageOpenFont; ?><?PHP echo $titleFee; ?> :<?PHP echo $pagecloseFont; ?></strong></h4>
							<div class="col-xs-6">
							
								<h4 id="monthlyFeeOutput" <?PHP echo $pageStyle2; ?>><?PHP echo $pageOpenFont; ?><?PHP echo $pagecloseFont; ?></h4>
								<p id="pricePerStudent" class="hidden" style="color:blue;text-align:right;font-size:px;font-style:;margin-top:0px;margin-bottom:5px;"><b></b></p>
							...
							<div class="col-xs-7">
								<p style="text-align:right;margin-top:-20px;">
									<div class="input-group" style="margin-right:-20px;">
										    ...
										    <a style="padding-left:80px;" type="button" data-tippy-content="<?PHP echo $titleTooltip4; ?>" > <i style="color:#f1592a;font-size:25px;" class="fa fa-question-circle"></i> </a>
						...
						<div class="form-group" style="margin-top:-5px">
							<p class=" col-xs-5"><span id="textNormalTutor"><?PHP echo $titleNormalTutor; ?></span><span id="textSchoolTeacher" style="display:none"><?PHP echo $titleSchoolTutor; ?></span>
							...
							<div class="col-xs-7">
								<p style="text-align:right;margin-top:-20px;">
									<div class="input-group" style="margin-right:-20px;">
										...
										<input <?PHP echo $pageStyle3; ?> type="text" id="normalTutorInput" class="form-control input-number" value="">
						...
						<div class="form-group" style="margin-top:-5px">
							<p class=" col-xs-5"><?PHP echo $titleStudent; ?> <a type="button" data-tippy-content="<?PHP echo $titleTooltip2; ?>" > <i style="color:#262262;" class="fa fa-info-circle"></i> </a> </p>
							<div class="col-xs-7">
								<p style="text-align:right;margin-top:-20px;">
									<div class="input-group" style="margin-right:-20px;">
									
										<input <?PHP echo $pageStyle3; ?> type="text" id="NoOfStudentsInput" name="NoOfStudentsInput" class="form-control input-number" value="" min="1" max="5" onChange="NoOfStudentsOnChange()">
						...
						<div class="form-group" style="margin-top:-5px">
							<p class=" col-xs-5"><?PHP echo $titleDuration; ?></p>
							<div class="col-xs-7">
								<p style="text-align:right;margin-top:-20px;">
									<div class="input-group" style="margin-right:-20px;">

										<input <?PHP echo $pageStyle3; ?> type="text" id="sessionDuration" name="sessionDuration" class="form-control input-number" value="<?PHP echo $clockTime; ?>">
						...
						<div class="form-group" style="margin-top:-5px">
							<p class=" col-xs-5"><?PHP echo $titleSession; ?> <a type="button" data-tippy-content="<?PHP echo $titleTooltip3; ?>" > <i style="color:#262262;" class="fa fa-info-circle"></i> </a> <br/>
							<font id="sessionWeek" style="text-align: right;font-size:10px;font-style: oblique;margin-top:0px;">1 <?PHP echo $titleSessWeek; ?></font></p>
							<div class="col-xs-7">
								<p style="text-align:right;margin-top:-20px;">
									<div class="input-group" style="margin-right:-20px;">
									
										<input <?PHP echo $pageStyle3; ?> type="text" id="sessionPerMonth" name="sessionPerMonth" class="form-control input-number" value="<?PHP echo $TotalSesi; ?>" min="4" max="16" >
...
<hr>
						<div class="form-group">
							<p class=" col-xs-3"><?PHP echo $titleSubTotal; ?> <a id="tooltipSubtotal" class="hidden" type="button" data-tippy-content="<?PHP echo $titleSubTotal2; ?>" ><i style="color:#f1592a;" class="fa fa-question-circle"></i></a> </p>
							<div class="col-xs-6"><center><font id="subtotalDic" class="hidden"></font></center></div>
							<div class="col-xs-3">
								<p id="subtotal" style="text-align: right;"></p>
							</div>
						...
						<div class="form-group" style="margin-top:0px;">
							<p class=" col-xs-7"><?PHP echo $titleRegister; ?></p>
							<div class="col-xs-5">
							
								<p id="registrationFeeOutput" style="text-align: right;"></p>
								
							</div>
						</div>
<hr>
						<div class="form-group">
							<h4 class=" col-xs-6"><strong><?PHP echo $pageStyleSpace.$pageStyleSpace; echo $pageOpenFont; ?><?PHP echo $titleTotal; ?> :<?PHP echo $pagecloseFont; ?></strong></h4>
							<div class="col-xs-6">
								<h4 id="totalOutput" style="text-align: right;"><strong style="color: #3C763D;"></strong></h4>							
							</div>
							
							<h4 class=" col-xs-8"><font style="font-size:15px;"><?PHP echo $pageStyleSpace.$pageStyleSpace; echo $pageOpenFont; ?> <span id="lokasi"></span><?PHP echo $pagecloseFont; ?></font></h4>
							<div class="col-xs-4">
...
function Procced() {
    ...
    $.ajax({
        ...
        success:function(result){
            ...
            document.getElementById("lokasi").innerHTML = LokasiLvl+' <?PHP echo $titleIn; ?>'+result.location;	
        }
    });
}
...
$(document).ready(function(){
	...
	var valueMonth = parseInt(document.getElementById("sessionPerMonth").value);
		...
		if( LokasiState == 'Online Tuition' ){
			...
			LokasiThis = LokasiLvl+' <?PHP echo $titleIn; ?> '+LokasiState;
		}
...
function normalTuitionCheckbox() {
    ...
    if(thisCheckbox == true){
		...
		if( document.getElementById("postOfflineValue").value != '' ){
			...
			var LokasiLvl   = '<?PHP echo $titleTitle; ?>';
			LokasiThis = LokasiLvl+' <?PHP echo $titleIn; ?> '+document.getElementById("postOfflineName").value;
			document.getElementById("lokasi").innerHTML = LokasiThis;
		}else{
