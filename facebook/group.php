...
if (isset($accessToken)) {
	...
	if (isset($_GET['code'])) {
		echo "<script>window.top.location.href='https://apps.facebook.com/tutorkami_namespace';</script>";
		exit;
	}
	...
	try {
		...
		if ($e->getCode() == 190) {
			...
			$loginUrl = $helper->getLoginUrl('https://apps.facebook.com/tutorkami_namespace/', $permissions);
