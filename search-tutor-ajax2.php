    ...
    <div class="container">
      <div class="panel panel-default">
        <div class="panel-body">
              <div class="col-sm-2">
                    <center> <div class="circle2"><img alt="avatar" src="'.$picProfile.'" /></div> <br/> '.$showRating.'</center>
              </div>
              <div class="col-sm-3">
                  <font style="color:#262262"><strong>'.$row['u_displayname'].'</strong></font> <br/><br/> '.$showGender.' <br/><br/> '.CalculateAge($row['ud_dob']).' years old <br/><br/> '.$Occu.'
              </div>
              <div class="col-sm-7">
                  Subject : '.ucwords($showSubTitle.$dataSubjek1).' <br/><br/> Level : '.$showLevelTitle.rtrim($showLevel2, ", ").' <br/><br/> '.$showContent.' <br/><br/> <a href="tutor_profile.php?did='.$row['u_displayid'].'" class="btn btn-oren" target="_blank">View Profile</a>  
              </div>
