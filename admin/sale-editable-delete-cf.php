    ...
    if( (isset($_SESSION['tk']['u_id'])) && ($_SESSION['tk']['u_id'] == '1' || $_SESSION['tk']['u_id'] == '8' || $_SESSION['tk']['u_id'] == '1579926' || $_SESSION['tk']['u_id'] == '1581081' || $_SESSION['tk']['u_id'] == '3') ){
        ...
        if($result->num_rows > 0){
            $row = $result->fetch_assoc();
                    ...
                    $i = 1;
                    $OldNo = " SELECT id, main_id, tab_name, month, row_no, cf FROM tk_sales_sub WHERE id != '".$row['id']."' AND main_id = '".$row["main_id"]."' AND tab_name = '".$row["tab_name"]."' AND month = '".$row["month"]."' AND row_no != '0' AND row_no = '999999' ORDER BY cf ASC   ";
