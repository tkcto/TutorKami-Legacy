...
if ($resultPicture->num_rows > 0) {
    while($rowPicture = $resultPicture->fetch_assoc()) {
				...
				$pix = sprintf("%'.07d", $rowPicture['u_profile_pic']);   // 0000045
				$pixAll = $pix.'_0.jpg';                                  //  0000045_0.jpg
				
				$thisFolder = 'https://www.tutorkami.com/images/profile/'.$pixAll; // https://www.tutorkami.com/images/profile/0000045_0.jpg
...
<!-- END PROFILE PICTURE-->
<script src="https://www.tutorkami.com/admin/js/plugins/dataTables/datatables.min.js"></script>
