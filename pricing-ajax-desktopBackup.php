...
if( $_SERVER['HTTP_REFERER'] == 'https://www.tutorkami.com/price' ){
	$pageBgColor = '';
	$pageColorBlack = '';
	$pageNormalTutor = 'style="text-align:center;margin-right:-30px;"';
	$pageMargin30 = 'style="margin-right:-30px;"';
	$pageMargin5 = 'style="margin-right:-5px;"';
}else{
	$pageBgColor = 'style="background-color:white;"';
	$pageColorBlack = 'color:black;';
	$pageNormalTutor = 'style="text-align:center;margin-left:-30px;"';
	$pageMargin30 = 'style="margin-left:-30px;"';
	$pageMargin5 = 'style="margin-left:-5px;"';
}*/
?>
					<form class="form-horizontal">
						...
						<div class="form-group" style="margin-top:-5px">
							<p class=" col-xs-5">Online Tuition</p>
							
							<div class="col-xs-7">
								<p style="text-align:right;margin-top:-20px;">
									<div class="input-group" style="margin-right:-20px;">
									
										    <a style="padding-left:50px;" type="button" data-toggle="tooltip" data-placement="bottom" title="Enjoy lower rates with online class (click the slider on the right)"> <i style="color:#f1592a;font-size:40px;" class="fa fa-question-circle"></i> </a>
										    <span style="padding-left:50px;"></span>
									        <a href="online-tuition-tutoring-class.php" target="blank" type="button" data-toggle="tooltip" data-placement="bottom" title=""> <i style="color:#262262;font-size:40px;" class="fa fa-info-circle"></i> </a>
										...
										<span class="input-group-btn">
											<label class="switch">
												<input type="checkbox" class="success" value="false" id="CheckboxnormalTutor111" onChange="normalTutorCheckbox11111()">
							...
							<div class="col-xs-7">
								<p style="text-align:right;margin-top:-20px;">
									<div class="input-group" style="margin-right:-20px;">
										...
										<input style="text-align:center;margin-right:-30px;" type="text" id="NoOfStudentsInput" name="NoOfStudentsInput" class="form-control input-number" value="<?PHP echo $_POST['person']; //echo $_POST['person']." pax"; ?>" min="1" max="5" onChange="NoOfStudentsOnChange()">
							...
							<div class="col-xs-7">
								<p style="text-align:right;margin-top:-20px;">
									<div class="input-group" style="margin-right:-20px;">
										...
										<input style="text-align:center;margin-right:-30px;" type="text" id="sessionPerMonth" name="sessionPerMonth" class="form-control input-number" value="<?PHP echo "4 sessions"; ?>" min="4" max="16" >
