...
$json_url = 'https://script.googleusercontent.com/macros/echo?user_content_key=3kCrs72RWDAHvmuioNP-IxAhjwJYMDYHnXPF9byEf138foFck1UMTBf6roKfTtWgRadRR1CUWumpcpJS-V1ulVLsmwTJhThWm5_BxDlH2jW0nuo2oDemN9CCS2h10ox_1xSncGQajx_ryfhECjZEnCeIDk7FrjUhWCIjmRlroINmvDKY3XSJcfybDph69Q2MW9GyMt9Ea8o3xBy8uZ2BZ6V-rV9yhQ38&lib=MV3qSAaQt0v3MPN5nd6UIZI9LPg1umDcO';
...
if($resultUserD->num_rows > 0){ 
  ...
  header('Content-Disposition: attachment; filename=PENDAFTARAN-HOME-TUISYEN.xls');
  echo $output;
