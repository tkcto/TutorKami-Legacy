...
.showme
{
	...
	<!--<link href="css/review/themify-icons.css" rel="stylesheet">-->
	<link href="https://demos.creative-tim.com/paper-bootstrap-wizard/assets/css/themify-icons.css" rel="stylesheet">
	

<input type="hidden" name="tutorID" id="tutorID" required="" value="<?PHP echo $tutorID; ?>">
<input type="hidden" name="parentID" id="parentID" required="" value="<?PHP echo $parentID; ?>">
<input type="hidden" name="jobID" id="jobID" required="" value="<?PHP echo $xxx; ?>">
...
<?PHP/*
if($getLan == "/my/"){	
	echo '<font style="margin-left:-15px;">Maklumbalas Tertutup</font>';
}else{
...
?>
		                        ...
		                        <div class="tab-content">
		                            <div class="tab-pane" id="Rate">
		                            	<div class="row">
											<h5 class="info-text description"><font color="#f1592a" size="3em"><b> <?php echo $REVIEW_STEP1_TITLE; ?> <?php echo $getUserDetails->data[0]->ud_first_name; ?> <?php echo $getUserDetails->data[0]->ud_last_name; 
if($getLan == "/my/"){	
         ...
         ?> <?php echo $TEXT_CLASS; ?></b></font></h5>
           ...
           if ($getUserDetails->data[0]->u_profile_pic != '') {
                ...
                ?>
													...
													<h6><font size="2em"><b><?php echo $getUserDetails->data[0]->ud_first_name; ?> <?php echo $getUserDetails->data[0]->ud_last_name; ?> ( <?php echo $ID_NO; ?> : <?php echo $getUserDetails->data[0]->u_displayid; ?>)</b></font></h6>
												</div>
											</div>
		                                    ...
		                                    <div class="col-sm-6">
		                                        <div class="form-group">
         <fieldset class="rating" style="font-size:160%;">
...
<!--
		                            ...
		                            <div class="tab-pane" id="Comments">
		                                <h5 class="info-text description"><font color="#f1592a" size="3em"><b> <?php echo $REVIEW_STEP2_QUESTION; ?> </b></font> <small ><font color="#f1592a"><b><?php echo $REQUIRED; ?></b></font></small> </h5>
		                                <div class="row">
...
<textarea class="form-control" rows="9" id="congratulation-text2" name="tutor_improve" ></textarea>
		                        ...
		                        <div class="wizard-footer">
		                            <div class="pull-right">
		                                ...
		                                <!--<button id="submitBtnLoad" class="hidden btn btn-finish btn-fill btn-sample btn-wd disabled"> <i class="fa fa-spinner fa-spin"></i> Loading </button>-->
