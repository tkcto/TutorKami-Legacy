...
if($_SESSION['auth']['user_role'] == '4') { 
	...
	if($resUserAT > 0){
        ...
        if ( $rowUserAT['signature_img2'] != '' ) {
 
    		$getSigAT = strtok($rowUserAT['signature_img2'], '_');
            ...
            $getTimeAT = getBetween($rowUserAT['signature_img2'],"_","_");
			if(strlen($getTimeAT) == '7'){
                ...
                $queryProof1AT = "SELECT * FROM tk_page_manage_translation WHERE pmt_id='80' AND pmt_noti='TRUE' "; 
...
<h1 class="text-center blue-txt"><?php echo $headerTitle; ?></h1><hr> <!-- text-uppercase -->

<?PHP
if($getLan == "/my/"){	
?>   
<a href="https://www.tutorkami.com/clients-terms-group.php" type="button" class="btn btn-oren" >English</a>  
<?PHP
}else{
?>   
<a href="https://www.tutorkami.com/my/clients-terms-group.php" type="button" class="btn btn-oren" >Bahasa Melayu</a>  
<?PHP
}
?>
	...
	<div id="content1" class="collapse in"><br/>
		...
		<a href="clients-terms.php" id="thisno1" type="button" class="btn btn-success btn-outline "><?php echo $headerButton; ?></a> 
		<?PHP if( $deviceIs == "mobile" ){ echo '<p></p>'; } ?>
		<a href="clients-terms-group.php"      id="thisno2" type="button" class="btn btn-success btn-primary"><?php echo $headerButton2; ?></a>
			...
			<form method="post" action="client-terms-of-accepting2.php">
			<div class="sigPad">
					...
					<div class="row">
							...
							if($resTCBM > 0){
								...
								if($rowTCBM = $queryTCBM->fetch_assoc()){ 
									...
									if ( $getUserDetails->data[0]->signature_img2 != '' ) {
										...
										$getSigColor = $getUserDetails->data[0]->signature_img2;
										...
										$getTime = getBetween2($getUserDetails->data[0]->signature_img2,"_","_");
										if(strlen($getTime) == '7'){
						...
						?>
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								...
								<?PHP
									...
									if ($getUserDetails->data[0]->signature_img2 != '') {									
												...
												$queryProof1 = "SELECT * FROM tk_page_manage_translation WHERE pmt_id='80' AND pmt_noti='TRUE' "; 
								...
								if ($getUserDetails->data[0]->signature_img2 != '') {
									...
									$date = $getUserDetails->data[0]->signature_img2;
									$date = strtok($date, '_');
									
									
												$queryProof3 = "SELECT * FROM tk_page_manage_translation WHERE pmt_id='80' AND pmt_noti='TRUE' "; 
							...
							<div class="col-lg-12">
								...
								<?PHP
								if ($getUserDetails->data[0]->signature_img2 != '') {
												$queryProof4 = "SELECT * FROM tk_page_manage_translation WHERE pmt_id='80' AND pmt_noti='TRUE' "; 
								...
								<?PHP 
								if ($getUserDetails->data[0]->signature_img2 != '') {
												$queryProof5 = "SELECT * FROM tk_page_manage_translation WHERE pmt_id='80' AND pmt_noti='TRUE' "; 
