...
if ($conn->connect_error) {
	...
	$queryTCBI = $conn->query("SELECT * FROM tk_page_manage_translation WHERE pmt_id='79'");
...
$filename = "Terms for 1-1 Tuition(BM).pdf";
try {
  ...
  $mpdf->SetTitle('Terms for 1-1 Tuition | tutorkami.com');
  $mpdf->WriteHTML($html);
