...
if($resultCheckSend->num_rows > 0){
    ...
    if ($resultLogWa->num_rows > 0) {*/
			...
			$sqlGeJob = "SELECT j_id, jt_j_id, jt_subject, j_deadline, j_telephone, j_creator_email, j_status, u_id, j_rating, j_email FROM tk_job INNER JOIN tk_job_translation ON jt_j_id = j_id WHERE j_id = '".$ajobid."' ";
