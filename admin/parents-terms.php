...
if(isset($_REQUEST['crs-saveBI'])){
 ...
 header('Location:parents-terms.php');
 exit();
}
        ...
        <div class="col-lg-12">
         <div class="ibox float-e-margins">
          <div class="ibox-title">
           <h5><b>Parents Terms & Condition Form</b> <span>(Last updated on <strong id="lastUpdated"></strong>)</span></h5>
...
<div class="container">
    ...
    <div class="tab-group rates-page-tabs">
        ...
        <ul class="nav nav-tabs responsive" role="tablist">
            <li role="presentation" class="active"><a href="#Personal" aria-controls="Personal" role="tab" data-toggle="tab" onClick="activeTabMain(this.id)" id="1" >Terms for 1-1 tuition</a></li>
...
function DownloadPDF(id) {
  if(id == '1'){
      window.open("https://www.tutorkami.com/admin/pdf5.php");
  }
  if(id == '2'){
      window.open("https://www.tutorkami.com/admin/pdf6.php");
  }
  if(id == '3'){
	 ...
	 if (x == true){
    	$.ajax({
    		...
    		success:function(result){
    			alert(result);
    			window.location = "parents-terms.php"
    		}
    	});
	 }
