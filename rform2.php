...
if($getLan == "/my/"){	
    ...
    $Q1andQ2 = '1. Name pelajar & Jantina *';
    $tooltip = 'Sila tekan + jika lebih dari 1 pelajar';
}else{
    ...
    $tooltip = 'Please press + if there are more than 1 student';
}
...
<!-- HERE -->
                    ...
                    <div class="form-group">
                        <label><?PHP echo $Q1andQ2; ?> <button onclick="thisBtn();" data-balloon-length="large" aria-label="<?PHP echo $tooltip; ?>" data-balloon-pos="down" data-balloon-break type="button" class="btn-plus btn btn-success">+</button>
                        </label>
...
<div class="row">
  ...
  <div style="<?PHP echo $padding; ?>" class="col">
      <label><?PHP echo $male; ?></label> <label style="margin-left:23px;"><?PHP echo $female; ?></label>
  </div>
</div>
...
<div class="row">
  ...
  <div style="<?PHP echo $padding; ?>" class="col">
                        <div class="this" style="margin-top:8px;">
                            <label style="margin-left:15px;" ><input type="radio" class="" name="gender" value="Male" ><span class="outside"><span class="inside"></span></span></label>
                            <label style="margin-left:50px;" ><input type="radio" class="" name="gender" value="Female" ><span class="outside"><span class="inside"></span></span></label>
                        </div>
...
<!-- HERE -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="this">
                            ...
                            <input onclick="thisfun3();" style="border-bottom: 1px solid black;<?PHP echo $width; ?>" type="text" class="no-border" name="otherNo" id="otherNo" placeholder="" />
                        </div>
...
function thisBtn(){
    ...
    timer = setTimeout(function(){
        //alert('test');
        var data = ' <div class="row"><div style="background-color:;" class="col"></div><div style="<?PHP echo $padding; ?>" class="col"><label></label> <label style="margin-left:23px;"></label></div></div>' +
'<div class="row"><div class="col"><input type="text" class="form-control no-border" name="Studentname'+xxx+'" ></div>' +
  '<div class="col" style="<?PHP echo $padding; ?>">' +
                        '<div class="this" style="margin-top:20px;">' +
                            '<label style="margin-left:15px;" ><input onclick="thisGender(this.id,this.value);" id="genderM'+xxx+'" type="checkbox" class="" name="gender'+xxx+'" value="Male" ><span class="outside"><span class="inside"></span></span></label>' +
                            '<label style="margin-left:54px;" ><input onclick="thisGender(this.id,this.value);" id="genderF'+xxx+'"type="checkbox" class="" name="gender'+xxx+'" value="Female" ><span class="outside"><span class="inside"></span></span></label>' +
                        '</div>' +
  '</div>' +
'</div>';
