...
if (isset($_POST['dataGrid'])) {
    ...
    $latest_balance = $tk + $hs + $grand_total_gp + $grand_total_deposit - $grand_total_expenses;
            ...
            <tbody id="table-bodyBank" style="font-size:14px;">
                ...
                <tr class="table-row">
                    ...
                    <td id="tk-data" class="row-data data-edit" style="font-size:14px;width:80px;text-align: right;" contenteditable="true">
                        <?php echo ($rowSelect['tk'] == 'kosong') ? '' : $rowSelect['tk']; ?>
                    </td>
                    ...
                    <td id="hs-data" class="row-data data-edit" style="font-size:14px;width:80px;text-align: right;" contenteditable="true">
                        <?php echo ($rowSelect['hs'] == 'kosong') ? '' : $rowSelect['hs']; ?>
                    </td>
                ...
                <tr class="table-row">
                    ...
                    <td id="" class="row-data" style="font-size:14px;width:80px;text-align: right;"> <?php echo number_format((str_replace(",", "", $rowSelect["tk"]) + str_replace(",", "", $rowSelect["hs"])), 2) ?></td>
                    <td id="" class="row-data" style="font-size:14px;width:150px;"> &nbsp;</td>
                    <td id="" class="row-data" style="font-size:14px;width:200px;"> &nbsp;</td>
                    <td id="" class="row-data" style="font-size:14px;width:150px;"> &nbsp;</td>
                    <td id="" class="row-data" style="font-size:14px;width:200px;"> &nbsp;</td>
                ...
                <tr class="table-row">
                    ...
                    <td id="latest-balance-data" class="row-data data-edit" style="font-size:14px;width:80px;text-align: right;" contenteditable="true">
                        <?php echo $latest_balance; ?>
                    </td>
