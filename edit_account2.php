        ...
        <p><span class="rad-txt">*</span> <?php echo REQUIRED; ?><br>
          ...
          <form class="form-horizontal" method="post" enctype="multipart/form-data" id="registration-form">
            ...
            <div class="form-group">
			  <label class="control-label col-sm-4"><?php echo VIDEO; ?> <span data-balloon-length="xlarge" aria-label="Upload a video profile to allow parents & students to get a feel of who you are, and why should they choose you to be their tutor.
...
*/
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                ...
                <button id="btnRealSave" type="submit" class="btn btn-default autoClick"><?php echo BUTTON_SAVE; ?></button>
