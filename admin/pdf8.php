...
if ($conn->connect_error) {
	...
	$queryTCBI = $conn->query("SELECT * FROM tk_page_manage_translation WHERE pmt_id='81'");
...
$filename = "Terms for Group Tuition(BM).pdf";
try {
  ...
  $mpdf->SetTitle('Terms for Group Tuition | tutorkami.com');
  $mpdf->WriteHTML($html);
