...
class Assets implements Runner {
	...
	public function admin_footer_text( $text ) {
		...
		return GlobalHelper::is_whitelabel() ? $text : '<em>' . sprintf( wp_kses_post( __( 'Thank you for using <a href="%s" target="_blank">Rank Math</a>', 'rank-math' ) ), 'https://rankmath.com/wordpress/plugin/seo-suite/' ) . '</em>';
	}
