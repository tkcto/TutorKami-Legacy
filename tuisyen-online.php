...
$queryLevel2 = $conn->query("SELECT tc_id, tc_description FROM tk_tution_course WHERE tc_id !='9' ORDER BY tc_id ASC");
...
if (($pos = strpos($actual_link, "?/")) !== FALSE) {    
	...
	$whatIWant = substr($whatIWant, 1);    
	
	$totalSlash = substr_count($whatIWant, "/"); 
	...
	$currentData = '';
			...
			if (substr_count($whatIWant, "/") == 0){
				...
				if( $getLevel != 'NULL'){
				    ...
				    if( $whatIWant == 'Undang-Undang' ){
				        $currentData .= 'Undang-Undang *';
				    }else if( $whatIWant == 'Mengaji-Al-Quran' ){
					    $currentData .= 'Mengaji Al-Quran *';
					}else{
				...
				if( $getLevel != 'NULL'){
				    ...
				    if( $Before == 'Undang-Undang' ){
				        $currentData .= 'Undang-Undang *';
				    }else if( $Before == 'Mengaji-Al-Quran' ){
					    $currentData .= 'Mengaji Al-Quran *';
					}else{
					    $currentData .= (str_replace("-"," ",$Before)).' *';
					}
				...
				if( $getLevel2 != 'NULL'){
				    ...
				    if( $After == 'Undang-Undang' ){
				        $currentData .= 'Undang-Undang *';
				    }else if( $After == 'Mengaji-Al-Quran' ){
					    $currentData .= 'Mengaji Al-Quran *';
					}else{
					    $currentData .= (str_replace("-"," ",$After)).' *';
					}
				...
				if( $getLevel2 != 'NULL'){
					...
					$currentData .= $replace.' *';*/
				    if( $getBetween == 'Undang-Undang' ){
    					$replace = str_replace("-","-",$getBetween);
    					$replace = str_replace(","," *",$replace);
    					$currentData .= $replace.' *';
				    }else if( $getBetween == 'Mengaji-Al-Quran' ){
    					$replace = 'Mengaji Al-Quran';
    					$replace = str_replace(","," *",$replace);
    					$currentData .= $replace.' *';
					}else{
    					$replace = str_replace("-"," ",$getBetween);
				...
				if( $getLevel3 != 'NULL'){
				    ...
				    if( $getLast == 'Undang-Undang' ){
    					$replace2 = str_replace("-","-",$getLast);
    					$replace2 = str_replace(","," *",$replace2);
    					$currentData .= $replace2.' *'; 
				    }else if( $getLast == 'Mengaji-Al-Quran' ){
    					$replace2 = 'Mengaji Al-Quran';
    					$replace2 = str_replace(","," *",$replace2);
    					$currentData .= $replace2.' *'; 
					}else{
    					$replace2 = str_replace("-"," ",$getLast);
				...
				if( $getLevel4 != 'NULL'){
					...
					$replace = str_replace(","," *",$replace);
					$currentData .= $replace.' *';*/
				    if( $secondLast == 'Undang-Undang' ){
    					$replace = str_replace("-","-",$secondLast);
    					$replace = str_replace(","," *",$replace);
    					$currentData .= $replace.' *';
				    }else if( $secondLast == 'Mengaji-Al-Quran' ){
    					$replace = 'Mengaji Al-Quran';
    					$replace = str_replace(","," *",$replace);
    					$currentData .= $replace.' *';
					}else{
...
$qSub = "SELECT * FROM tk_tution_subject WHERE ts_description IN ('".$array."') "; 
$rSub = $dbCon->query($qSub); 
if($rSub->num_rows > 0){ 
    while($dSub = $rSub->fetch_assoc()){
        $seoSub .= $dSub['ts_description'].',';
    }
}else{
    $seoSub = '';
}
...
<html lang="en">
   <head>
	  ...
	  <!--<title>Tutor & Guru Tuisyen Online <?PHP //echo str_replace(","," ",str_replace(",,",",",$seoSub)).' '.str_replace(","," ",str_replace(",,"," ",$seoLevel)); if( $seoCity != '' || $seoState != '' ){ echo ' di ';} echo str_replace(","," ",str_replace(",,",",",$seoCity)).' '.str_replace(","," ",str_replace(",,"," ",$seoState)); if( $seoCity != '' || $seoState != '' ){ echo ' & Sekitarnya';} ?></title>
	  <meta name="description" content="Dapatkan cikgu online tuition <?PHP //echo str_replace(","," ",str_replace(",,",",",$seoSub)).' '.str_replace(","," ",str_replace(",,"," ",$seoLevel)); if( $seoCity != '' || $seoState != '' ){ echo ' di ';} echo str_replace(","," ",str_replace(",,",",",$seoCity)).' '.str_replace(","," ",str_replace(",,"," ",$seoState)); if( $seoCity != '' || $seoState != '' ){ echo ' & sekitarnya dengan lebih mudah, selamat dan ada jaminan';} ?>" />
	  -->
	  <title>Tutor & Guru Tuisyen Online <?PHP echo str_replace(","," ",str_replace(",,",",",$seoSub)).' '.str_replace(","," ",str_replace(",,"," ",$seoLevel)); ?></title>
	  <meta name="description" content="Dapatkan cikgu online tuition <?PHP echo str_replace(","," ",str_replace(",,",",",$seoSub)).' '.str_replace(","," ",str_replace(",,"," ",$seoLevel)); if( $seoSub != '' || $seoLevel != '' ){ echo ' dengan lebih mudah, selamat dan ada jaminan';} ?>" />
           ...
           <ul class="nav navbar-nav navbar-right off_dropd">
					   ...
					   if($_SESSION['auth']['user_role'] == '4') { ?>
                        <li class="dropdown text-right" id="shadow">
                           ...
                           Welcome <?php echo ucfirst($_SESSION['auth']['first_name']); ?>  <span class="caret"></span></a>
                           <ul class="dropdown-menu text-right" role="menu">
...
$(document).on('click', function (e){
	...
	<link href="css-pricing/rotating-card/rotating-card-seo.css" rel="stylesheet" type="text/css"  />
		            ...
		            <div class="wizard-container" >
		                <div class="card wizard-card" data-color="red" id="wizardProfile">
		                        	...
		                        	<h1 class="wizard-title textH1" id="search-term">
		                        	   <p><font color="#14114e" style=""><strong>
		                        	       <!--Tutor & Guru Tuisyen Online <?PHP //echo str_replace(","," ",str_replace(",,",",",$seoSub)).' '.str_replace(","," ",str_replace(",,"," ",$seoLevel)); if( $seoCity != '' || $seoState != '' ){ echo ' di ';} echo str_replace(","," ",str_replace(",,",",",$seoCity)).' '.str_replace(","," ",str_replace(",,"," ",$seoState)); if( $seoCity != '' || $seoState != '' ){ echo ' & Sekitarnya';} ?>-->
		                        	       Tutor & Guru Tuisyen Online <?PHP echo str_replace(","," ",str_replace(",,",",",$seoSub)).' '.str_replace(","," ",str_replace(",,"," ",$seoLevel)); ?>
		                        	   </strong></font></p>
									</h1>
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <p class="control-label textH3" style="text-align: center;font-family: system-ui;">
                                                    <!--Dapatkan cikgu online tuition <?PHP //echo str_replace(","," ",str_replace(",,",",",$seoSub)).' '.str_replace(","," ",str_replace(",,"," ",$seoLevel)); if( $seoCity != '' || $seoState != '' ){ echo ' di ';} echo str_replace(","," ",str_replace(",,",",",$seoCity)).' '.str_replace(","," ",str_replace(",,"," ",$seoState)); if( $seoCity != '' || $seoState != '' ){ echo ' & sekitarnya dengan lebih mudah, selamat dan ada jaminan';} ?>-->
                                                    Dapatkan cikgu online tuition <?PHP echo str_replace(","," ",str_replace(",,",",",$seoSub)).' '.str_replace(","," ",str_replace(",,"," ",$seoLevel)); if( $seoSub != '' || $seoLevel != '' ){ echo ' dengan lebih mudah, selamat dan ada jaminan';} ?>
                                                </p>
											</div>
                                        </div>
...
<br/>
		                    	...
		                    	<div class="wizard-header">
		                    	    <img alt="" class="img-responsive center-block" src="folder-tuisyen-online/red-line.PNG"  /><br/>
		                        	<h2 class="wizard-title textH2" id="search-term">
		                        	   <p><font color="#14114e" style=""><strong>HARGA KHIDMAT TUISYEN ONLINE 1-TO-1 / KUMPULAN KECIL</strong></font></p>
		                        	</h2><br/>
		                    	</div>
		                            ...
		                            <div class="tab-pane" id="about">
		                              <div class="row" style="padding-left: 10px;padding-right: 10px;">
		                                	...
		                                	<div class="col-sm-12">
		                                    	...
		                                    	<div class="form-group label-floating">
		                                        	<p class="control-label" style="text-align: left;">Lokasi Anda atau taip Online Tuition <small>(required)</small></p>	
	                                            		<!--<div class="input-group ui-widget" style="text-align: left;">
                											 ...
                											 <input type="text" id="selectState" name="selectState" class="my_form_control ui-autocomplete-input customInput" placeholder="Your Location or type Online Tuition" />
	                                               		</div>-->
	                                               		<input style="text-align: left;" type="text" value="Online Tuition" id="selectState" name="selectState" class="my_form_control ui-autocomplete-input customInput" placeholder="Your Location or type Online Tuition" />
		                                    	</div>
...
<section class="how_works gray_bg2" style="margin-top:-80px;">
   ...
   <div class="container">
      <div class="row" style="text-align: left;">
         ...
         <div class="col-md-offset-2 col-md-8" id="wizardProfile" style="margin-top:-60px;">
...
print_r($currentData2);
echo '<br/>';
print_r($currentData);
*/
?>
               <div class="row">
                  <div class="col-md-3"><span class="org-txt "><strong><font size='3'>Tahap & Subjek :</font></strong></span></div>
                  <div class="col-md-9">
                     <div class="form-group">
						<?php	
							$levelSelected = "";
                     ...
                     <div class="form-group">
                        <div class="levelShowHide" style="display: none;">
                           <div class="dropbox">Sila Pilih Subjek</div>
                           <div class="dropPop">
                              <div class="row">
               ...
               <div class="row">
				...
				?>
                  <div class="col-md-3"><span class="org-txt "><strong><font size='3'>Jantina :</font></strong></span></div>
                  <div class="col-md-3">
                  ...
                  <div class="col-md-3 hidden"> <span class="org-txt text-uppercase"><strong><?php echo OCCUPATION; ?>:</strong></span> </div>
               ...
               <!--<div class="col-md-6"> <span class="org-txt text-uppercase"><strong>&nbsp;</strong></span> </div>
               <div class="col-md-6">&nbsp;</div>-->
               <div class="row">
                  <div class="col-md-3"><span class="org-txt"><strong><font size='3'>Mengajar Tuisyen Online :</font></strong></span></div>
                  <div class="col-md-3">
                     <select class="form-control" name="TeachOnline" id="TeachOnline">
                        <option value="1"><?php echo YES; ?></option>
                        <!--<option value="0"><?php echo NO; ?></option>-->
                     </select>
                  </div>
               ...
               <div class="row">
                  <div class=" col-sm-12 col-md-12 search-tb" id="submitsearch" align="center">
                     <br>
                     <button type="button" name="submitBtn" onclick="pretest()" class="btn btn-orange btn-lg">Senaraikan</button>
                  </div>
               </div>
            </form>
<br/><br/>
...
if($currentData2 != ''){
                ...
                $sqlFilterState = " SELECT * FROM tk_states WHERE st_name IN ('".$arrayState."') ";                 
...
$thisRecord = '';
                    ...
                    $sqlFilterRating = " SELECT  conduct_online, conduct_online_text, ud_about_yourself, u_displayid, ud_current_occupation_other, ud_current_occupation, ud_dob, u_displayname, u_gender, u_profile_pic, u_id, u_status, u_role, ud_u_id, tac_u_id, tac_st_id, tac_city_id, trs_u_id, trs_tc_id, trs_ts_id, rr_tutor_id, rr_rating, rr_status, avg(rr_rating) FROM tk_review_rating 
                    ...
                    WHERE u_status = 'A' AND u_role = '3' AND conduct_online = 'Yes' AND conduct_online_text != '' "; 
                    ...
                    if($resultFilterRating->num_rows > 0){ 
                        while($rowFilterRating = $resultFilterRating->fetch_assoc()){
                            $thisRecord .= $rowFilterRating['u_id'].',';
                                ...
                                $sqlFilterPhoto = " SELECT  conduct_online, conduct_online_text, ud_about_yourself, u_displayid, ud_current_occupation_other, ud_current_occupation, ud_dob, u_displayname, u_gender, u_id, u_status, u_role, u_profile_pic, ud_u_id, tac_u_id, tac_st_id, tac_city_id, trs_u_id, trs_tc_id, trs_ts_id FROM tk_user 
                                ...
                                if($resultFilterPhoto->num_rows > 0){ 
                                    while($rowFilterPhoto = $resultFilterPhoto->fetch_assoc()){ 
                                        ...
                                        $sqlFilterLatestLogin = " SELECT  conduct_online, conduct_online_text, ud_about_yourself, u_displayid, ud_current_occupation_other, ud_current_occupation, ud_dob, u_displayname, u_gender, u_profile_pic, u_id, u_status, u_role, u_modified_date, ud_u_id, tac_u_id, tac_st_id, tac_city_id, trs_u_id, trs_tc_id, trs_ts_id FROM tk_user 
                                        LEFT JOIN tk_user_details ON ud_u_id = u_id
                                        LEFT JOIN tk_tutor_area_cover ON tac_u_id = u_id
                                        LEFT JOIN tk_tutor_subject ON trs_u_id = u_id 
                                        WHERE u_status = 'A' AND u_role = '3' AND conduct_online = 'Yes' AND conduct_online_text != '' "; 
                                                                ...
                                                                <div class="front">
                                                                    ...
                                                                    <div class="content jumpHere">
                                                                        <div class="main"> 
                                                                                ...
                                                                                while($rowTutorSubject = $resultTutorSubject->fetch_assoc()){
                                                                                    ...
                                                                                    if($resultTutorSubject2->num_rows > 0){ 
                                                                                        while($rowTutorSubject2 = $resultTutorSubject2->fetch_assoc()){
                                                                                            $loopTitleSubject .= $rowTutorSubject2['ts_description'].', '; 
                                                                                        }
                                                                            ...
                                                                            echo 'test'.$loopCityName.''.$getThisCity2;
																			*/
...
/*An array containing all the country names in the world:*/
	<?php
		...
		$sqlS = "SELECT ts.ts_id, tc.tc_description, ts.ts_description FROM tk_tution_subject ts
