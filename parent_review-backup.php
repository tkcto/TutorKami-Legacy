...
<textarea class="form-control" rows="9" id="congratulation-text2" name="tutor_improve" ></textarea>
		                        ...
		                        <div class="wizard-footer">
		                            <div class="pull-right">
		                                ...
		                                <input type='button' class='btn btn-finish btn-fill btn-sample btn-wd' name='finish' <?PHP if($getLan == "/my/"){ echo "value='Hantar'"; }else{ echo "value='Submit'"; } ?> onclick="Finish()"/>
		                            </div>
