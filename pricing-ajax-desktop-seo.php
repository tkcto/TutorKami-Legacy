	...
	*/
	...
	if ($resultRate->num_rows > 0) {
		$rowRate = $resultRate->fetch_assoc();
			...
			?>
			<div class="col-sm-12" style="background-color:white;text-align: left;">
				<div class="alert-message alert-message-success" style="background-color:white;">
				<?PHP
  ...
  Please insert discount code.
					...
					<form class="form-horizontal" style="background-color:white;">
						<div class="form-group" >
							<h4 class=" col-xs-6"><strong><font color="black">FEES :</font></strong></h4>
							<div class="col-xs-6">
							
								<h4 id="monthlyFeeOutput" style="text-align: right;color:black;"><font color="black"><?PHP echo "<strong> RM ".$MonthlyFee." / month</strong>"; ?></font></h4>
							...
							<div class="col-xs-7">
								<p style="text-align:right;margin-top:-20px;">
									<div class="input-group" style="margin-right:-20px;">
										...
										<input style="text-align:center;margin-left:-30px;" type="text" id="normalTutorInput" class="form-control input-number" value="<?PHP echo "RM ".$thisRate." / hour"; ?>">
							...
							<div class="col-xs-7">
								<p style="text-align:right;margin-top:-20px;">
									<div class="input-group" style="margin-right:-20px;">
										...
										<input style="text-align:center;margin-left:-30px;" type="text" id="NoOfStudentsInput" name="NoOfStudentsInput" class="form-control input-number" value="<?PHP echo $_POST['person']." pax"; ?>" min="1" max="5" onChange="NoOfStudentsOnChange()">
						
										<span class="input-group-btn">
											<label style="margin-left:-30px;">&nbsp;&nbsp;</label>
										</span>
										<span class="input-group-btn">
											<button style="margin-left:-30px;color:white;" type="button" class="btn btn-default btn-number btn-sm" data-type="minus" data-field="NoOfStudentsInput">
												<span class="glyphicon glyphicon-minus" style="font-size:20px;"></span>
											</button>
										</span>
										<span class="input-group-btn">
											<button style="color:white;" type="button" class="btn btn-default btn-number btn-sm" data-type="plus" data-field="NoOfStudentsInput">
							...
							<div class="col-xs-7">
								<p style="text-align:right;margin-top:-20px;">
									<div class="input-group" style="margin-right:-20px;">
										...
										<input style="text-align:center;margin-left:-30px;" type="text" id="sessionDuration" name="sessionDuration" class="form-control input-number" value="<?PHP echo "1 hour 30 mins"; ?>">

										<span class="input-group-btn">
											<label style="margin-left:-30px;">&nbsp;&nbsp;</label>
										</span>
										<span class="input-group-btn">
											<button style="margin-left:-30px;color:white;" type="button" class="btn btn-default btn-number btn-sm" data-type="minus" data-field="sessionDuration">
												<span class="glyphicon glyphicon-minus" style="font-size:20px;"></span>
											</button>
										</span>
										<span class="input-group-btn">
											<button style="color:white;" type="button" class="btn btn-default btn-number btn-sm" data-type="plus" data-field="sessionDuration">
												<span class="glyphicon glyphicon-plus" style="font-size:20px;"></span>
											</button>
										</span>
							...
							<div class="col-xs-7">
								<p style="text-align:right;margin-top:-20px;">
									<div class="input-group" style="margin-right:-20px;">
										...
										<input style="text-align:center;margin-left:-30px;" type="text" id="sessionPerMonth" name="sessionPerMonth" class="form-control input-number" value="<?PHP echo "4 session"; ?>" min="4" max="16" >
						
										<span class="input-group-btn">
											<label style="margin-left:-30px;">&nbsp;&nbsp;</label>
										</span>
										<span class="input-group-btn">
											<button style="margin-left:-30px;color:white" type="button" class="btn btn-default btn-number btn-sm" data-type="minus" data-field="sessionPerMonth">
												<span class="glyphicon glyphicon-minus" style="font-size:20px;"></span>
											</button>
										</span>
										<span class="input-group-btn">
											<button style="color:white;" type="button" class="btn btn-default btn-number btn-sm" data-type="plus" data-field="sessionPerMonth">
												<span class="glyphicon glyphicon-plus" style="font-size:20px;"></span>
											</button>
										</span>
...
<hr>
						<div class="form-group">
							<h4 class=" col-xs-6"><strong><font color="black">TOTAL :</font></strong></h4>
							<div class="col-xs-6">
