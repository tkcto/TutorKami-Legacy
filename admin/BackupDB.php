...
EXPORT_DATABASE("localhost","tutorka1_live","_+11pj,oow.L","tutorka1_tutorkami_db" ); 
...
{ 
	...
	//echo $content; exit;
  $backup_name ="/home/tutorka1/BackupDB/DB-" . date("d-m-Y") . "-" . date("h-i-s");
  $handle = fopen($backup_name.'.sql','w+');
