  ...
  <div class="form-group col-xs-6">
    ...
    <div class="col-md-6">
							<div class="input-group clockpicker" data-autoclose="true" data-placement="bottom" data-align="left">
								<input type="text" class="form-control" placeholder="02:30 pm" id="st_time" name="record_start_time" readonly>
  ...
  <div class="form-group col-xs-6">
    ...
    <div class="col-md-6">
							<div class="input-group">
								<input type="text" class="form-control" data-field="time" data-format="hh:mm AA" readonly placeholder="05:30 pm" id="en_time" name="record_end_time">
					...
					<div class="form-group col-xs-7">
						...
						<div class="input-group">
							...
							<input disabled type="text" class="form-control" id="duration2" value="2 hours"/>
					...
					<div class="form-group">							
						<div class="col-xs-12">
							...
							<textarea class="form-control" name="record_remark" rows="6" placeholder="Fill in your remarks here"></textarea>
						</div>
					</div>
					...
					<div class="form-group col-sm-6">
						<div style="margin-top:10px;">
							...
							<a href="tutor_list_of_classes.php" class="btn btn-default"><span class="glyphicon glyphicon-hand-left"></span> &nbsp;&nbsp;<?php echo "Back"; ?></a>
         ...
         <div class="col-md-12">
			<div class="row">
               <div class="col-md-4"><strong><?php echo STUDENT_NAME; ?> :</strong> <?php echo $row->cl_student;?></div>
               ...
               <div class="col-md-4"><strong><?php echo HOURS_BALANCE; ?> : </strong><i id="hours_balance_new"></i> <?php //echo HOURS; ?></div>
					...
					<div class="panel panel-default">
						...
						<div class="col-lg-12">
							<div class="form-horizontal">
                                ...
                                <div class="row">
                                    <div class="col-xs-4">
                                        <p class="text-center"><?php echo $record_row->cr_start_time;?></p>
                                    </div>
                                    <div class="col-xs-4">
                                         <div class="horizontalline" style="margin-left:-0px;margin-right:-0px;"></div>
                                    </div>
                                    <div class="col-xs-4">
                                        <p class="text-center"><?php echo $record_row->cr_end_time;?></p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-xs-4">
...
<button type="button" class="btn btn-info btn-lg hidden" data-toggle="modal" data-target="#tourGuideModal" id="openModal">Open Modal</button>
<!-- Modal -->
...
<!--
<link href="fadhli/MDTimePicker/mdtimepicker.css" rel="stylesheet" type="text/css">
<input type="text" class="form-control" placeholder="02:30 pm" id="timepicker"/>
<script src="//code.jquery.com/jquery.min.js"></script>
<script src="fadhli/MDTimePicker/mdtimepicker.js"></script>
<script>
