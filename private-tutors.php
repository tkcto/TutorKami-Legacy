...
<html lang="en">
   <head>
	  ...
	  <title><?PHP echo str_replace(","," ",str_replace(",,",",",$seoSub)).' '.str_replace(","," ",str_replace(",,"," ",$seoLevel)); ?> Tutors for Home Tuition <?PHP if( $seoCity != '' || $seoState != '' ){ echo ' in ';} echo str_replace(","," ",str_replace(",,",",",$seoCity)).' '.str_replace(","," ",str_replace(",,"," ",$seoState)); if( $seoCity != '' || $seoState != '' ){ echo ' & Nearby Areas';} ?></title>
	  <meta name="description" content="Get <?PHP echo str_replace(","," ",str_replace(",,",",",$seoSub)).' '.str_replace(","," ",str_replace(",,"," ",$seoLevel)); ?> private tutors for home tuition <?PHP if( $seoCity != '' || $seoState != '' ){ echo ' in ';} echo str_replace(","," ",str_replace(",,",",",$seoCity)).' '.str_replace(","," ",str_replace(",,"," ",$seoState)); if( $seoCity != '' || $seoState != '' ){ echo ' & nearby areas easier, safer & with a guarantee';} ?>" />
      ...
      <div class="carousel-inner" role="listbox">
         ...
         <div class="item  active ">
			<?php if(stristr($_SERVER['HTTP_USER_AGENT'], "Mobile")){ // if mobile browser ?>
				<img src="folder-tuisyen-online/private-tuition.jpg">
			<?php }else { // desktop browser ?>
				<img src="folder-tuisyen-online/private-tuition.jpg" style="padding-top: 80px;">
			<?php } ?>
		            ...
		            <div class="wizard-container" >
		                <div class="card wizard-card" data-color="red" id="wizardProfile">
		                        	...
		                        	<h1 class="wizard-title textH2" id="search-term">
		                        	   <p><font color="#14114e" style=""><strong><?PHP echo str_replace(","," ",str_replace(",,",",",$seoSub)).' '.str_replace(","," ",str_replace(",,"," ",$seoLevel)); ?> Tutors for Home Tuition <?PHP if( $seoCity != '' || $seoState != '' ){ echo ' in ';} echo str_replace(","," ",str_replace(",,",",",$seoCity)).' '.str_replace(","," ",str_replace(",,"," ",$seoState)); if( $seoCity != '' || $seoState != '' ){ echo ' & Nearby Areas';} ?></strong></font></p>
		                        	</h1>
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <p class="control-label textH3" style="text-align: center;font-family: system-ui;">Get <?PHP echo str_replace(","," ",str_replace(",,",",",$seoSub)).' '.str_replace(","," ",str_replace(",,"," ",$seoLevel)); ?> private tutors for home tuition <?PHP if( $seoCity != '' || $seoState != '' ){ echo ' in ';} echo str_replace(","," ",str_replace(",,",",",$seoCity)).' '.str_replace(","," ",str_replace(",,"," ",$seoState)); if( $seoCity != '' || $seoState != '' ){ echo ' & nearby areas easier, safer & with a guarantee';} ?></p>
                                            </div>
                                        </div>
...
<br/>
		                    	...
		                    	<div class="wizard-header">
		                        	...
		                        	<h2 class="wizard-title textH2" id="search-term">
		                        	   <p><font color="#14114e" style=""><strong>Benefits of Getting a Private Tutor for Personal Tuition</strong></font></p>
		                        	</h2><br/>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-10">
                                                <p class="control-label textH3" style="text-align: left;font-family: system-ui;">Student will get tutor's full attention</p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-10">
                                                <p class="control-label textH3" style="text-align: left;font-family: system-ui;">Lessons are conducted at your preferred place & time</p>
                                            </div>
                                        </div>
		                        	   ...
		                        	   <p><font color="#14114e" style=""><strong>Why Choose TutorKami</strong></font></p>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12">
                                                ...
                                                <p class="control-label textH3" style="text-align: center;font-family: system-ui;">Tutors are required to complete all lessons agreed before payment is released to them. This will prevent cases of tutor asking payment upfront, and did not show up later for lessons</p>
                                            </div>
                                        </div><br/><br/><br/>
                                        <div class="row">
                                            <div class="col-xs-12">
		                    	...
		                    	<div class="wizard-header">
		                        	<h2 class="wizard-title textH2" id="search-term">
		                        	   <p><font color="#14114e"><strong>Get instant quotation for private tutor service in your location</strong></font></p>
		                        	</h2>
		                    	</div>
...
?>	
            ...
            <form method="post" id="filter_user">
               ...
               <div class="row">
                  <div class="col-md-3"><span class="org-txt"><strong><?php echo 'Level & Subject'; ?>:</strong></span></div>
                  <div class="col-md-9">
                     <div class="form-group">
						<?php	
							$levelSelected = "";
               ...
               <div class="row">
				  ...
				  ?>
                  <div class="col-md-3"><span class="org-txt"><strong><?php echo 'Conduct Online Tuition'; ?>:</strong></span></div>
                  <div class="col-md-3">
