...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 offset-md-3 col-sm-8 offset-sm-2 col-xs-12 text-center wow fadeIn">
                        ...
                        <a href="<?php echo basename(__FILE__).'?action=remove_db'; ?>" class="btn btn-primary mr-2 page-scroll">Drop Database</a>
        ...
        } elseif (isset($_GET['action']) && $_GET['action'] == 'remove_db') {

            include $_SERVER['DOCUMENT_ROOT'].'/admin/classes/config.php.inc';
