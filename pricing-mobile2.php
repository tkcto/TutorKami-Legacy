...
<div style="margin-left:13px;">
		<div class="row">
			...
			<div class="col-xs-6">
				<div class="form-group">
					<h4 id="monthlyFeeOutput" class="text-left"><strong><?PHP echo " RM ".$fourWeek." / month"; ?></strong></h4>
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-xs-6">
					<p id="pricePerStudent" class="text-left" style="width:150px;color:blue;margin-left:-14px;margin-bottom:10px;"></p>		
<!--<input readonly style="width:150px;" type="text" value="(RM 150.00 / student)">					-->
			</div>
		</div>
</div>		
<div class="row">
    <div class="col-xs-6"><p><span id="textNormalTutor">Normal Tutor</span><span id="textSchoolTeacher" style="display:none;">School Teacher</span>
				<a type="button" data-toggle="tooltip" data-placement="bottom" title="Price might be higher by RM10/hour or more, if tutor is a school teacher, or has experience more than 5 years"><i class="fa fa-question-circle"></i></a></p></div>
    <div class="col-xs-4" style="margin-left:-33px;margin-top:-5px;">
		<input readonly style="text-align:center;width:93px;" type="text" id="normalTutorInput" class="form-control input-number" value="<?PHP echo "RM ".$OneHour." / hour"; ?>">
    ...
    <div class="col-xs-2">
        ...
        <!--<div class="form-group" style="margin-top:-5px">
			<p class=" col-xs-5"><span id="textNormalTutor">Normal Tutor</span><span id="textSchoolTeacher" style="display:none;margin-left:-5px;">School Teacher</span>
            ...
            <div class="col-xs-7">
                <p style="text-align:right;margin-top:-20px;">
					<div class="input-group" style="margin-right:-20px;">
						<input style="text-align:center;margin-right:-30px;width:100px;" type="text" id="normalTutorInput" class="form-control input-number" value="<?PHP echo "RM ".$OneHour." / hour"; ?>">
...
<div class="row">
    <div class="col-xs-6"><p>No. Of Students</p></div>
    <div class="col-xs-4" style="margin-left:-33px;margin-top:-5px;">
		<input readonly style="text-align:center;width:93px;" type="text" id="NoOfStudentsInput" name="NoOfStudentsInput" class="form-control input-number" value="<?PHP echo $_POST['person']." pax"; ?>" min="1" max="5" onChange="NoOfStudentsOnChange()">
    </div>
    <div class="col-xs-2" style="margin-left:-12px;">
        ...
        <!--<div class="form-group" style="margin-top:-5px">
            <p class=" col-xs-4">No. Of Students</p>
            <div class="col-xs-8">
                <p style="text-align:right;margin-top:-20px;">
					<div class="input-group" style="margin-right:-20px;">
						<input style="text-align:center;margin-right:-30px;width:100px;" type="text" id="NoOfStudentsInput" name="NoOfStudentsInput" class="form-control input-number" value="<?PHP echo $_POST['person']." pax"; ?>" min="1" max="5" onChange="NoOfStudentsOnChange()">
						
						<span class="input-group-btn">
							<label style="margin-right:-30px;"></label>
						</span>
						<span class="input-group-btn">
							<button style="margin-right:-30px;" type="button" class="btn btn-default btn-number btn-xs" data-type="minus" data-field="NoOfStudentsInput">
...
<div class="row">
    <div class="col-xs-6"><p>Session Duration</p></div>
    <div class="col-xs-4" style="margin-left:-33px;margin-top:-5px;">
    ...
    <div class="col-xs-2" style="margin-left:-12px;">
        ...
        <!--<div class="form-group" style="margin-top:-5px">
            ...
            <div class="col-xs-7">
                <p style="text-align:right;margin-top:-20px;">
					<div class="input-group" style="margin-right:-20px;">
						<input style="text-align:center;margin-right:-30px;width:100px;" type="text" id="sessionDuration" name="sessionDuration" class="form-control input-number" value="<?PHP echo "1 hour 30 mins"; ?>">

						<span class="input-group-btn">
							<label style="margin-right:-30px;"></label>
						</span>
						<span class="input-group-btn">
							<button style="margin-right:-30px;" type="button" class="btn btn-default btn-number btn-xs" data-type="minus" data-field="sessionDuration">
...
<div class="row">
    <div class="col-xs-6"><p>Session Per Month<br/>
			<font id="sessionWeek" style="text-align: left;font-size:10px;font-style: oblique;margin-top:0px;">1 session(s) / week</font></p></p></div>
    <div class="col-xs-4" style="margin-left:-33px;margin-top:-5px;">
		<input readonly style="text-align:center;width:93px;" type="text" id="sessionPerMonth" name="sessionPerMonth" class="form-control input-number" value="<?PHP echo "4 session"; ?>" min="4" max="16" >
	</div>
    <div class="col-xs-2" style="margin-left:-12px;">
						<span class="input-group-btn">
        ...
        <!--<div class="form-group" style="margin-top:-5px">
            ...
            <div class="col-xs-7">
                <p style="text-align:right;margin-top:-20px;">
					<div class="input-group" style="margin-right:-20px;">
						<input style="text-align:center;margin-right:-30px;width:100px;" type="text" id="sessionPerMonth" name="sessionPerMonth" class="form-control input-number" value="<?PHP echo "4 session"; ?>" min="4" max="16" >
						
						<span class="input-group-btn">
							<label style="margin-right:-30px;"></label>
						</span>
						<span class="input-group-btn">
							<button style="margin-right:-30px;" type="button" class="btn btn-default btn-number btn-xs" data-type="minus" data-field="sessionPerMonth">
								<span class="glyphicon glyphicon-minus" style="font-size:25px;"></span>
							</button>
						</span>
						<span class="input-group-btn">
        ...
        <!--<div class="form-group" style="">
            <p class=" col-xs-9">Registration Fee (RM50/student, one-time)</p>
            <div class="col-xs-3" style="margin-left:-15px;">
                <p id="registrationFeeOutput" style="text-align: left;"><?PHP echo "+ RM 50"; ?></p>
            </div>
        </div>-->

		<div class="row">
			<div class="col-xs-8">Registration Fee (RM50/student, one-time)</div>
			<div class="col-xs-4">
...
<div style="margin-left:13px;">
		...
		<div class="row">
			<div class="col-xs-6"> </div>
			<div class="col-xs-6">
					<p id="pricePerStudent" class="text-left" style="width:150%;color:blue;margin-left:-14px;margin-bottom:10px;"></p>			
			</div>
		</div>
</div>		
        <!--<div class="form-group">
            <h4 class=" col-xs-6"><strong>MONTHLY FEE :</strong></h4>
            <div class="col-xs-6">
                <h4 id="monthlyFeeOutput" style="text-align: left;"><?PHP echo "<strong> RM ".$fourWeek." / month</strong>"; ?></h4>
                <p id="pricePerStudent" style="color:blue;text-align:left;font-size:px;font-style:;margin-top:0px;margin-bottom:5px;;margin-left:-5px;">
				</p>
		   </div>
        </div>-->
		
<div class="row">
    <div class="col-xs-5"><p><span id="textNormalTutor">Normal Tutor</span><span id="textSchoolTeacher" style="display:none;">School Teacher</span>
				<a type="button" data-toggle="tooltip" data-placement="bottom" title="Price might be higher by RM10/hour or more, if tutor is a school teacher, or has experience more than 5 years"><i class="fa fa-question-circle"></i></a></p></div>
    <div class="col-xs-4">
		<input style="text-align:center;" type="text" id="normalTutorInput" class="form-control input-number" value="<?PHP echo "RM ".$OneHour." / hour"; ?>">
...
<div class="row">
    <div class="col-xs-4"><p>No. Of Students</p></div>
    <div class="col-xs-5">
		<input style="text-align:center;" type="text" id="NoOfStudentsInput" name="NoOfStudentsInput" class="form-control input-number" value="<?PHP echo $_POST['person']." pax"; ?>" min="1" max="5" onChange="NoOfStudentsOnChange()">
    </div>
    <div class="col-xs-3" style="margin-left:-18px;">
						<span class="input-group-btn">
							<button type="button" class="btn btn-default btn-number btn-xs" data-type="minus" data-field="NoOfStudentsInput">
								<span class="glyphicon glyphicon-minus" style="font-size:18px;"></span>
							</button>
						</span>
						<span class="input-group-btn">
							<button type="button" class="btn btn-default btn-number btn-xs" data-type="plus" data-field="NoOfStudentsInput">
...
<div class="row">
    <div class="col-xs-4"><p>Session Duration</p></div>
    <div class="col-xs-5">
		<input style="text-align:center;" type="text" id="sessionDuration" name="sessionDuration" class="form-control input-number" value="<?PHP echo "1 hour 30 mins"; ?>">
	</div>
    <div class="col-xs-3" style="margin-left:-18px;">
						<span class="input-group-btn">
							<button type="button" class="btn btn-default btn-number btn-xs" data-type="minus" data-field="sessionDuration">
...
<div class="row">
    <div class="col-xs-4"><p>Session Per Month<br/>
			<font id="sessionWeek" style="text-align: left;font-size:10px;font-style: oblique;margin-top:0px;">1 session(s) / week</font></p></p></div>
    <div class="col-xs-5">
		<input style="text-align:center;" type="text" id="sessionPerMonth" name="sessionPerMonth" class="form-control input-number" value="<?PHP echo "4 session"; ?>" min="4" max="16" >
	</div>
    <div class="col-xs-3" style="margin-left:-18px;">
						<span class="input-group-btn">
							<button type="button" class="btn btn-default btn-number btn-xs" data-type="minus" data-field="sessionPerMonth">
