...
?>
    ...
    <!--<h2><p><b><?PHP echo $rowNoti['title']; ?></b></p></h2>-->
    <div class="scroll">


<button id="no1" type="button" class="btn btn-custom" >News </button> <button id="no2" type="button" class="btn btn-default" >Job Vacancy </button>
