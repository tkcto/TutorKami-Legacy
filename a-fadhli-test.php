...
?>
  ...
  <!-- <link href="pdf/signature-pad-master/assets/jquery.signaturepad.css" rel="stylesheet"> -->
			...
			<div class="pull-right" id="canvas" > 
				<?PHP
                  if ($getUserDetails->data[0]->signature_img != '') {
					...
					$pixAll = $pix.".png";
					?><img src="<?php echo APP_ROOT."images/signature/".$pixAll; ?>" alt="signature" style="border:4px solid #444; border-radius: 15px; background-color: #fafafa;"> <?PHP
                  } else {
                    ?> 
                    <div class="sig sigWrapper">
						<div class="typed"></div>
						<canvas id="newSignature" width="450" height="314" style="border:4px solid #444; border-radius: 15px; background-color: #fafafa;"></canvas>
