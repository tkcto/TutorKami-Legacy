...
//$dbCon->close();
						...
						/* END fadhli */	
                           ...
                           echo '<small class="text-success">(Activated)</small>';
                              ...
                              echo '<small class="text-danger" style="color:#ae0202;font-size:13px;margin-right:40px;"><b>(Banned)</b></small>';
                           }
                     //tutor
                           //admin
                     ...
                     ?>					 <!--<button class="btn btn-sm btn-primary sign-btn-box mrg-right-15" name="dont_hire">DON'T HIRE</button>-->					
