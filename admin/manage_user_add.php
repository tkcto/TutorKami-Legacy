...
//$dbCon->close();
						...
						/* END fadhli */	
                           ...
                           }elseif ($userRow['u_status'] == 'C'){                              echo '<small class="text-danger" style="color:#ae0202;font-size:13px;margin-right:40px;"><b>(DON'."'".'T HIRE)</b></small>';                           }
                     //tutor
                           //admin
                     ...
                     }elseif ($userRow['u_status'] == 'C'){                        if( $userRow['ud_client_status_2'] != NULL && $userRow['ud_client_status_2'] == 'Tuition Centre' ){                            echo '<small class="text-success">(DON'."'".'T HIRE)</small>';                        }else{                            echo '<small class="text-danger">(DON'."'".'T HIRE)</small>';                        }                                             }elseif ($userRow['u_status'] == 'B'){
...
if ( $userRow['signature_img'] != '' ) {
        ...
        echo '<li onClick="clickLi(this.id)" id="this4" class="" style="margin-right:5px;background-color:#'.$bgColor.'" ><a data-toggle="tab" href="#tab-4"><font id="fColor" color="'.$fColor.'">Proof1</font></a></li>';
}else{
    echo '<li onClick="clickLi(this.id)" id="this4" class="" style="margin-right:5px;"><a data-toggle="tab" href="#tab-4"><font>Proof1</font></a></li>';
}
...
if ( $userRow['signature_img2'] != '' ) {
        ...
        echo '<li onClick="clickLi(this.id)" id="thisProof2" class="" style="background-color:#'.$abgColor.'" ><a data-toggle="tab" href="#tab-Proof2"><font id="afColor" color="'.$afColor.'">Proof2</font></a></li>';
}else{
    echo '<li onClick="clickLi(this.id)" id="thisProof2" class=""><a data-toggle="tab" href="#tab-Proof2"><font>Proof2</font></a></li>';
}
//$dbCon->close();   
?>
...
if( $userRow['ud_client_status_2'] != NULL && $userRow['ud_client_status_2'] != 'Tuition Centre' ){
		if ( $userRow['signature_img'] != '' ) {
				...
				echo '<li onClick="clickLi(this.id)" id="thisparent4" class="" style="margin-right:5px;background-color:#'.$bgColor.'" ><a data-toggle="tab" href="#tab-parent4"><font id="fColor" color="'.$fColor.'">Proof1 (for 1-1 tuition)</font></a></li>';
		}else{
			echo '<li onClick="clickLi(this.id)" id="thisparent4" class="" style="margin-right:5px;"><a data-toggle="tab" href="#tab-parent4"><font>Proof1 (for 1-1 tuition)</font></a></li>';
		}
		...
		if ( $userRow['signature_img2'] != '' ) {
				...
				echo '<li onClick="clickLi(this.id)" id="thisProofparent2" class="" style="background-color:#'.$abgColor.'" ><a data-toggle="tab" href="#tab-Proofparent2"><font id="afColor" color="'.$afColor.'">Proof2 (for group tuition)</font></a></li>';
		}else{
			echo '<li onClick="clickLi(this.id)" id="thisProofparent2" class=""><a data-toggle="tab" href="#tab-Proofparent2"><font>Proof2 (for group tuition)</font></a></li>';
		}
}else{
		...
		if ( $userRow['signature_img3'] != '' ) {
				...
				echo '<li onClick="clickLi(this.id)" id="thisparent4TuitionCentre" class="" style="margin-right:5px;background-color:#'.$bgColor.'" ><a data-toggle="tab" href="#tab-parent4TuitionCentre"><font id="fColor" color="'.$fColor.'">Proof</font></a></li>';
		}else{
			echo '<li onClick="clickLi(this.id)" id="thisparent4TuitionCentre" class="" style="margin-right:5px;"><a data-toggle="tab" href="#tab-parent4TuitionCentre"><font>Proof</font></a></li>';
		}
}
//$dbCon->close();   
?>
...
';    
                                  ...
                                  <?php if(isset($userRow) && $userRow !== null && $userRow['u_role'] == 3) { ?>
                                    ...
                                    <div class="form-group">
                                       <div class="col-sm-2"> <button type="button" class="btn btn-copy" onclick="copyFrontEnd('https://www.tutorkami.com/tutor_profile?did=<?php echo (isset($_POST['u_displayid'])) ? $_POST['u_displayid'] : ( (isset($userRow) && $userRow !== null) ? $userRow['u_displayid'] : '' ) ;?>')"><i class="fa fa-copy"></i> Copy to Front Link</button> </div>
                                       <div class="col-sm-3">
                                        <?PHP 
                                        ...
                                        ?>  																				<?PHP                                         if( isset($userRow) && $userRow['u_status'] == 'C' ){                                              ?>                                            <h4 class="text-danger hidden-xs hidden-sm" style="margin-top:10px;color:#ae0202;font-size:13px;margin-left:20px;"><b>Don't hire this tutor</b></h4>                                            <h4 class="text-danger hidden-lg hidden-md" style="margin-top:10px;color:#ae0202;font-size:12px;margin-left:60px;"><b>Don't hire this tutor</b></h4>                                            <?PHP                                        }                                        ?>   
                                       </div>
...
?>
                                    ...
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group">
                                       <label class="col-sm-3 control-label"><?php if(isset($userRow) && $userRow !== null && $userRow['u_role'] == 4) {echo 'Actual Email :';}else{echo 'Last Name :';} ?></label>
                                       <div class="col-sm-9"><input type="text" class="form-control" name="ud_last_name" value="<?php echo (isset($_POST['ud_last_name'])) ? $_POST['ud_last_name'] : ( (isset($userRow) && $userRow !== null) ? $userRow['ud_last_name'] : '' ) ;?>" ></div>
                                    </div>  
<?php 	
}
                                                ...
                                                $result = $conDB->query($query); 
                                                    if($result->num_rows > 0){ 
                                                        while($row = $result->fetch_assoc()){  
                                                            ?><option value="<?php echo $row['city_id']; ?>" <?php if ( $userRow['ud_workplace_city'] == $row['city_id'] ) echo 'selected' ; ?> ><?php echo $row['city_name']; ?></option><?php
                                                        } 
                                                    }
                                    ...
                                    <div class="row">
                                       <div class="col-md-6">
                                         <label class="radio-inline udradio2" style="font-size:15px;">
                                           <input type="radio" name="conduct_online" value="Yes" <?php if( isset($userRow) && $userRow !== null && ($userRow['conduct_online'] == 'Yes' ) ){ echo 'checked';} ?> >
                                       ...
                                       <div class="col-md-6">
                                         <label class="radio-inline udradio2" style="font-size:15px;">
                                           <input type="radio" name="conduct_online" value="No"  <?php if( isset($userRow) && $userRow !== null && ($userRow['conduct_online'] == 'No') ){ echo 'checked';}  ?> >
                                           No</label>
                                       </div>
                                     </div>
                                 </div>
...
?>    
          ...
          <div class="panel-body">
              <div class="col-xs-12">
				<div class="pull-left checkbox mobileCheckboxFont">
					<label style="font-size: 1em"><input type="checkbox" <?PHP if(strpos($userRow['conduct_online_text'], 'Microsoft Teams') !== false){ echo "checked"; } ?> onchange="handleChange1();" name="toolsname1" value="Microsoft Teams"><span class="cr"><i class="cr-icon fa fa-check"></i></span>Microsoft Teams</label><br>
					<label style="font-size: 1em"><input type="checkbox" <?PHP if(strpos($userRow['conduct_online_text'], 'Google Hangouts') !== false){ echo "checked"; } ?> onchange="handleChange1();" name="toolsname1" value="Google Hangouts"><span class="cr"><i class="cr-icon fa fa-check"></i></span>Google Hangouts</label><br>
					<label style="font-size: 1em"><input type="checkbox" <?PHP if(strpos($userRow['conduct_online_text'], 'Google Meet') !== false){ echo "checked"; } ?> onchange="handleChange1();" name="toolsname1" value="Google Meet"><span class="cr"><i class="cr-icon fa fa-check"></i></span>Google Meet</label><br>
					<label style="font-size: 1em"><input type="checkbox" <?PHP if(strpos($userRow['conduct_online_text'], 'Google Classroom') !== false){ echo "checked"; } ?> onchange="handleChange1();" name="toolsname1" value="Google Classroom"><span class="cr"><i class="cr-icon fa fa-check"></i></span>Google Classroom</label><br>
					<label style="font-size: 1em"><input type="checkbox" <?PHP if(strpos($userRow['conduct_online_text'], 'Google Duo') !== false){ echo "checked"; } ?> onchange="handleChange1();" name="toolsname1" value="Google Duo"><span class="cr"><i class="cr-icon fa fa-check"></i></span>Google Duo</label><br>
					<label style="font-size: 1em"><input type="checkbox" <?PHP if(strpos($userRow['conduct_online_text'], 'Google Doc') !== false){ echo "checked"; } ?> onchange="handleChange1();" name="toolsname1" value="Google Doc"><span class="cr"><i class="cr-icon fa fa-check"></i></span>Google Doc</label><br>
					<label style="font-size: 1em"><input type="checkbox" <?PHP if(strpos($userRow['conduct_online_text'], 'Zoom') !== false){ echo "checked"; } ?> onchange="handleChange1();" name="toolsname1" value="Zoom"><span class="cr"><i class="cr-icon fa fa-check"></i></span>Zoom</label><br>
					<label style="font-size: 1em"><input type="checkbox" <?PHP if(strpos($userRow['conduct_online_text'], 'Skype') !== false){ echo "checked"; } ?> onchange="handleChange1();" name="toolsname1" value="Skype"><span class="cr"><i class="cr-icon fa fa-check"></i></span>Skype</label><br>
					<label style="font-size: 1em"><input type="checkbox" <?PHP if(strpos($userRow['conduct_online_text'], 'WhatsApp') !== false){ echo "checked"; } ?> onchange="handleChange1();" name="toolsname1" value="WhatsApp"><span class="cr"><i class="cr-icon fa fa-check"></i></span>What's App</label><br>
					<label style="font-size: 1em"><input type="checkbox" <?PHP if(strpos($userRow['conduct_online_text'], 'Telegram') !== false){ echo "checked"; } ?> onchange="handleChange1();" name="toolsname1" value="Telegram"><span class="cr"><i class="cr-icon fa fa-check"></i></span>Telegram</label><br>
					<label style="font-size: 1em"><input type="checkbox" <?PHP if(strpos($userRow['conduct_online_text'], 'Lark') !== false){ echo "checked"; } ?> onchange="handleChange1();" name="toolsname1" value="Lark"><span class="cr"><i class="cr-icon fa fa-check"></i></span>Lark</label><br>
					<label style="font-size: 1em"><input type="checkbox" <?PHP if(strpos($userRow['conduct_online_text'], 'GeoGebra') !== false){ echo "checked"; } ?> onchange="handleChange1();" name="toolsname1" value="GeoGebra"><span class="cr"><i class="cr-icon fa fa-check"></i></span>GeoGebra</label><br>
					<label style="font-size: 1em"><input type="checkbox" <?PHP if(strpos($userRow['conduct_online_text'], 'Whereby') !== false){ echo "checked"; } ?> onchange="handleChange1();" name="toolsname1" value="Whereby"><span class="cr"><i class="cr-icon fa fa-check"></i></span>Whereby</label><br>
					<label style="font-size: 1em"><input type="checkbox" <?PHP if(strpos($userRow['conduct_online_text'], 'Others') !== false){ echo "checked"; } ?> onchange="handleChange1();" name="toolsname1" value="Others"><span class="cr"><i class="cr-icon fa fa-check"></i></span>Others</label><br>


				</div>
				<div class="pull-right checkbox mobileCheckbox mobileCheckboxFont" >
					<br><label style="font-size: 1em"><input type="checkbox" <?PHP if(strpos($userRow['conduct_online_text'], 'Phone Call') !== false){ echo "checked"; } ?> onchange="handleChange1();" name="toolsname1" value="Phone Call"><span class="cr"><i class="cr-icon fa fa-check"></i></span>Phone Call</label><br>
					<label style="font-size: 1em"><input type="checkbox" <?PHP if(strpos($userRow['conduct_online_text'], 'Video Call') !== false){ echo "checked"; } ?> onchange="handleChange1();" name="toolsname1" value="Video Call"><span class="cr"><i class="cr-icon fa fa-check"></i></span>Video Call</label><br>
					<label style="font-size: 1em"><input type="checkbox" <?PHP if(strpos($userRow['conduct_online_text'], 'Webex') !== false){ echo "checked"; } ?> onchange="handleChange1();" name="toolsname1" value="Webex"><span class="cr"><i class="cr-icon fa fa-check"></i></span>Webex</label><br>
					<label style="font-size: 1em"><input type="checkbox" <?PHP if(strpos($userRow['conduct_online_text'], 'YouTube') !== false){ echo "checked"; } ?> onchange="handleChange1();" name="toolsname1" value="YouTube"><span class="cr"><i class="cr-icon fa fa-check"></i></span>YouTube</label><br>
					<label style="font-size: 1em"><input type="checkbox" <?PHP if(strpos($userRow['conduct_online_text'], 'Facebook') !== false){ echo "checked"; } ?> onchange="handleChange1();" name="toolsname1" value="Facebook"><span class="cr"><i class="cr-icon fa fa-check"></i></span>Facebook</label><br>
					<label style="font-size: 1em"><input type="checkbox" <?PHP if(strpos($userRow['conduct_online_text'], 'FaceTime') !== false){ echo "checked"; } ?> onchange="handleChange1();" name="toolsname1" value="FaceTime"><span class="cr"><i class="cr-icon fa fa-check"></i></span>FaceTime</label><br>
					<label style="font-size: 1em"><input type="checkbox" <?PHP if(strpos($userRow['conduct_online_text'], 'Instagram') !== false){ echo "checked"; } ?> onchange="handleChange1();" name="toolsname1" value="Instagram"><span class="cr"><i class="cr-icon fa fa-check"></i></span>Instagram</label><br>
					<label style="font-size: 1em"><input type="checkbox" <?PHP if(strpos($userRow['conduct_online_text'], 'Email') !== false){ echo "checked"; } ?> onchange="handleChange1();" name="toolsname1" value="Email"><span class="cr"><i class="cr-icon fa fa-check"></i></span>Email</label><br>
					<label style="font-size: 1em"><input type="checkbox" <?PHP if(strpos($userRow['conduct_online_text'], 'Quizziz') !== false){ echo "checked"; } ?> onchange="handleChange1();" name="toolsname1" value="Quizziz"><span class="cr"><i class="cr-icon fa fa-check"></i></span>Quizziz</label><br>
					<label style="font-size: 1em"><input type="checkbox" <?PHP if(strpos($userRow['conduct_online_text'], 'Kahoot') !== false){ echo "checked"; } ?> onchange="handleChange1();" name="toolsname1" value="Kahoot"><span class="cr"><i class="cr-icon fa fa-check"></i></span>Kahoot</label><br>
					<label style="font-size: 1em"><input type="checkbox" <?PHP if(strpos($userRow['conduct_online_text'], 'Chegg') !== false){ echo "checked"; } ?> onchange="handleChange1();" name="toolsname1" value="Chegg"><span class="cr"><i class="cr-icon fa fa-check"></i></span>Chegg</label><br>
					<label style="font-size: 1em"><input type="checkbox" <?PHP if(strpos($userRow['conduct_online_text'], 'Edmodo') !== false){ echo "checked"; } ?> onchange="handleChange1();" name="toolsname1" value="Edmodo"><span class="cr"><i class="cr-icon fa fa-check"></i></span>Edmodo</label><br>
					<label style="font-size: 1em"><input type="checkbox" <?PHP if(strpos($userRow['conduct_online_text'], 'TeamLink') !== false){ echo "checked"; } ?> onchange="handleChange1();" name="toolsname1" value="TeamLink"><span class="cr"><i class="cr-icon fa fa-check"></i></span>TeamLink</label>
    ...
    </div><input style="width: 80%" type="hidden" id="hiddentoolsname1" name="hiddentoolsname1" value="<?php echo (isset($_POST['conduct_online_text'])) ? $_POST['conduct_online_text'] : ( (isset($userRow) && $userRow !== null) ? $userRow['conduct_online_text'] : '' );?>" >
                                    ...
                                    <div class="row">
                                       <div class="col-md-6">
                                         <label class="radio-inline" style="font-size:15px;">
                                           <input type="radio" name="conduct_class" value="Yes" <?php if( isset($userRow) && $userRow !== null && ($userRow['conduct_class'] == 'Yes' ) ){ echo 'checked';} ?> >
                                           Yes</label>
                                       </div>
                                       <div class="col-md-6">
                                         <label class="radio-inline" style="font-size:15px;">
                                           <input type="radio" name="conduct_class" value="No"  <?php if( isset($userRow) && $userRow !== null && ($userRow['conduct_class'] == 'No') ){ echo 'checked';}  ?> >
                                           No</label>
                                       </div>
                                     </div>
                                 </div>
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-9">
                                    <div class="row">
                                       <div class="col-md-6">
                                         <label class="radio-inline udradio2" style="font-size:15px;">
                                           <input type="radio" name="student_disability" value="Yes" <?php if( isset($userRow) && $userRow !== null && ($userRow['student_disability'] == 'Yes' ) ){ echo 'checked';} ?> >
                                           Yes</label>
                                       </div>
                                       <div class="col-md-6">
                                         <label class="radio-inline udradio2" style="font-size:15px;">
                                           <input type="radio" name="student_disability" value="No"  <?php if( isset($userRow) && $userRow !== null && ($userRow['student_disability'] == 'No') ){ echo 'checked';}  ?> >
                                           No</label>
                                       </div>
                                     </div>
                                 </div>
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-9">
                                    <div class="row">
                                       <div class="col-md-6">
                                         <label class="radio-inline" style="font-size:15px;">
                                           <input type="radio" name="ud_client_status" value="Tuition Centre" <?php if( isset($userRow) && $userRow !== null && ($userRow['ud_client_status'] == 'Tuition Centre' || $userRow['ud_client_status'] == '1') ){ echo 'checked';} ?> >
                                       ...
                                       <div class="col-md-6">
                                         <label class="radio-inline" style="font-size:15px;">
                                           <input type="radio" name="ud_client_status" value="0" <?php if( isset($userRow) && $userRow !== null && ($userRow['ud_client_status'] == '0') ){ echo 'checked';}  ?> >
...
if($result->num_rows > 0){
    ...
    ?><option value="1384" <?php if ( $userRow['ud_city'] == '1384' ) echo 'selected' ; ?> >Online Tuition</option><?php
}
...
if ($payment2->num_rows > 0) {
    while($payment3 = $payment2->fetch_assoc()) {
        ...
        if(strpos($payment3['ph_receipt'], 'trial') !== false){
                ...
                <tr class="footable-even" style="display: table-row;">
                    <td class="footable-visible" style="width: 120px;">
                     <font color="#266569" style="cursor: pointer;"  onclick="openPopup(<?PHP echo $payment3['ph_id'].','.$payment3['ph_amount'].','.$payment3['ph_rf'].','.$payment3['hour']; ?>,'<?PHP echo $payment3['tutor']; ?>','<?PHP echo date("d/m/Y", strtotime($payment3['ph_date'])); ?>','<?PHP echo $payment3['description']; ?>','client','<?PHP echo $payment3['description_rf']; ?>')">
                    ...
                    <td class="footable-visible" style="width: 80px;"><button onClick="deletePayment(<?php echo $payment3['ph_id'];?>)" type="button" class="btn btn-danger2 btn-sm">Delete</button></td>
                </tr>
                <?PHP
        }else if( $payment3['ph_receipt'] == 'temp' ){
        ...
        }else if (strpos($payment3['ph_receipt'], 'beginning') !== false) {
                              ...
                              <div class="form-row">
									<div class="form-group col-md-6">
										...
										if($resRForm > 0){
											...
											?>
        										<p> <b>Student’s name :</b>                           <font style="color:#266569;font-weight: bold;"><?PHP echo $rowRForm['name']; ?></font>
        										...
        										<p>
        										<p> <b>Gender :</b>                                   <font style="color:#266569;font-weight: bold;"><?PHP echo $rowRForm['gender']; ?></font><p>
        										<p> <b>Home address :</b>                             <font style="color:#266569;font-weight: bold;"><?PHP echo $rowRForm['address']; ?></font><p>
        										<p> <b>Name of student’s school :</b>                 <font style="color:#266569;font-weight: bold;"><?PHP echo $rowRForm['school']; ?></font><p>
        										<p> <b>Relationship with student :</b>                <font style="color:#266569;font-weight: bold;"><?PHP echo $rowRForm['relationship']; ?></font><p>
        										<p> <b>Occupation :</b>                               <font style="color:#266569;font-weight: bold;"><?PHP echo $rowRForm['occupation']; ?></font><p>
        										<p> <b>DOB :</b>                                      <font style="color:#266569;font-weight: bold;"><?PHP if($rowRForm['dob'] != ''){ echo getAge($rowRForm['dob']); } ?></font><p>
        										<p> <b>How did you get to know about TutorKami? :</b> <font style="color:#266569;font-weight: bold;"><?PHP echo $rowRForm['know']; ?></font><p>												
											<?PHP
											}
										}
										?>
                                        ...
                                        ?>
                                            <tr class="footable-even" style="display: table-row;">
                                               <td class="footable-visible" style="width: 120px;">
                                                     ...
                                                     <font color="#266569" style="cursor: pointer;"  onclick="openPopup(<?PHP echo $payment3Tutor['ph_id'].','.$payment3Tutor['ph_amount'].','.$payment3Tutor['ph_rf'].','.$payment3Tutor['hour']; ?>,'<?PHP echo $payment3Tutor['tutor']; ?>','<?PHP echo date("d/m/Y", strtotime($payment3Tutor['ph_date'])); ?>','<?PHP echo $payment3Tutor['description']; ?>','tutor','<?PHP echo $payment3Tutor['description_rf']; ?>')">
                                               ...
                                               <td class="footable-visible" style="width: 80px;">
                                                ...
                                                <td class="footable-visible" style="width: 80px;"><button onClick="deletePayment(<?php echo $payment3Tutor['ph_id'];?>)" type="button" class="btn btn-danger2 btn-sm">Delete</button></td>
                                            </tr>
                                        <?PHP
                                        }
                                    }
...
<!-- luqman city -->
                        ...
                        <div id="tab-10" class="tab-pane">
                           <div class="panel-body">
                               <p><font color="blue">Available Time Slots </font></p>
...
$(document).ready(function(){
    ...
    if (isset($_SESSION['tabReceipt'])) {
        if( $_SESSION['tabReceipt'] == "tutortutor" ){ 
            ...
            ?>$("a[href='#tab-PV']").trigger('click');<?PHP  
        }
               ...
               if(name2 == ''){
                   ...
                   exit();
					...
					if($('.thishahah').filter(function(){ return !this.value.trim(); }).length){
					   ...
					   var day = $("select[name='day[]']").map(function(){return $(this).val();}).get();
					   var nameNew = $("input[name='nameNew[]']").map(function(){return $(this).val();}).get();
               ...
               if(name3 == '0'){
                   ...
                   exit();
					...
					if($('.hahah').filter(function(){ return !this.value.trim(); }).length){
					   ...
					   var day = $("select[name='dayPHP[]']").map(function(){return $(this).val();}).get();
					   var nameNew = $("input[name='namePHP[]']").map(function(){return $(this).val();}).get();
