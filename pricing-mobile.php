...
<div class="col-sm-12">
    ...
    <form class="form-horizontal">
        ...
        <div class="form-group" style="margin-top:-5px">
			<p class=" col-xs-6"><span id="textNormalTutor">Normal Tutor</span><span id="textSchoolTeacher" style="display:none">School Teacher</span>
				...
				<div class="col-xs-12">
					<p style="text-align:right;margin-top:-20px;">
						<div class="input-group" style="margin-right:-20px;">
							<input disabled style="text-align:center;margin-right:-30px;" type="text" id="normalTutorInput" class="form-control input-number" value="<?PHP echo "RM ".$OneHour." / hour"; ?>">
						</div>
					</p>
				</div>
				<div class="col-xs-12">
					<p style="text-align:right;margin-top:-20px;"><br/>
						<div class="input-group" style="margin-right:-20px;">
...
<br/>
        <div class="form-group" style="margin-top:-5px">
            <p class=" col-xs-6">No. Of Students</p>
            <div class="col-xs-6">
				<div class="col-xs-12">
					<p style="text-align:right;margin-top:-20px;">
						<div class="input-group" style="margin-right:-20px;">
							<input disabled style="text-align:center;margin-right:-30px;" type="text" id="NoOfStudentsInput" name="NoOfStudentsInput" class="form-control input-number" value="<?PHP echo $_POST['person']." pax"; ?>" min="1" max="5" onChange="NoOfStudentsOnChange()">
						</div>
					</p>
				</div>
				<div class="col-xs-12">
...
<br/>
        <div class="form-group" style="margin-top:-5px">
            <p class=" col-xs-6">Session Duration</p>
            <div class="col-xs-6">
				<div class="col-xs-12">
					<p style="text-align:right;margin-top:-20px;">
						<div class="input-group" style="margin-right:-20px;">
							<input disabled style="text-align:center;margin-right:-30px;" type="text" id="sessionDuration" name="sessionDuration" class="form-control input-number" value="<?PHP echo "1 hour 30 mins"; ?>">
						</div>
					</p>
				</div>
				<div class="col-xs-12">
...
<br/>
        <div class="form-group" style="margin-top:-5px">
            <p class=" col-xs-6">Session Per Month <br/>
			<font id="sessionWeek" style="text-align: right;font-size:10px;font-style: oblique;margin-top:0px;">1 session(s)/week</font></p>
            <div class="col-xs-6">
				<div class="col-xs-12">
					<p style="text-align:right;margin-top:-20px;">
						<div class="input-group" style="margin-right:-20px;">
							<input disabled style="text-align:center;margin-right:-30px;" type="text" id="sessionPerMonth" name="sessionPerMonth" class="form-control input-number" value="<?PHP echo "4 session"; ?>" min="4" max="16" >
						</div>
					</p>
				</div>
				<div class="col-xs-12">
        ...
        <div class="form-group" style="">
            <p class=" col-xs-6">Registration Fee (One - Time)</p>
            <div class="col-xs-6">
        ...
        <div class="form-group">
            <div class="col-xs-12">
				...
				*Discounts if you take more than 1 session 1 week (except intensive classes). Contact our team for further info.
                </p>
			</div>
        </div>
    </form>
