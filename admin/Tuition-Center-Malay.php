...
if ($conn->connect_error) {
	...
	$queryTCBI = $conn->query("SELECT * FROM tk_page_manage_translation WHERE pmt_id='85'");
...
$filename = "Terms for Tuition Center(BM).pdf";
try {
  ...
  $mpdf->SetTitle('Terms for Tuition Center | tutorkami.com');
  $mpdf->WriteHTML($html);
