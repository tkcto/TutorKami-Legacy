...
?>
<button type="button" class="btnSummary btn btn-default pull-right">Summary</button>
<button type="button" class="btnExpenses btn btn-default pull-right">Expenses</button>
