...
?>	
	...
	<div id="content1" class="collapse in"><br/><br/>
		...
		<a href="terms-one-to-one.php" id="thisno1" type="button" class="btn btn-success btn-outline">Terms of Accepting 1-to-1 Tuition Job</a> 
		<a href="terms-group.php"      id="thisno2" type="button" class="btn btn-success btn-primary">Additional terms : Group Tuition</a>

			<input type="hidden" name="displayid" id="displayid" value="<?php echo $getUserDetails->data[0]->u_displayid; ?>">
			<div id="thiscontent1" class="notbold hidden">
			    <br><br>
			    <div class="loader">
			...
			<div id="thiscontent2" class="collapse in">
...
if($getLan == "/my/"){	
	...
	if($resTCBM > 0){
		if($rowTCBM = $queryTCBM->fetch_assoc()){ 
			...
			$a = explode('/',$rowTCBM['pmt_lastupdated']);
			$dateFormat2Color = (int)($a[2].$a[1].$a[0]);
			...
			if ( $getUserDetails->data[0]->signature_img2 != '' ) {
        		...
        		$b = explode('/',$getSigColor);
        		$dateFormatColor = (int)($b[2].$b[1].$b[0]);
        		...
        		$yummy   = ['<font style="color:#dc3545;font-style: oblique;">', '</font>'];
                    ...
                    /*if($dateFormat2Color > $dateFormatColor){
                        echo '<font style="font-style: oblique;">'.htmlspecialchars_decode($rowTCBM['pmt_pagedetail']).'</font>'; //green
	...
	if($resTCBI > 0){
		if($rowTCBI = $queryTCBI->fetch_assoc()){ 
			...
			$a = explode('/',$rowTCBI['pmt_lastupdated']);
			$dateFormat2Color = (int)($a[2].$a[1].$a[0]);
...
?>
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="pull-right" id="canvas" > 
								...
								if ($getUserDetails->data[0]->signature_img2 != '') {									
                                            ...
                                            $queryProof1 = "SELECT * FROM tk_page_manage_translation WHERE pmt_id='82' AND pmt_noti='TRUE' "; 
							...
							if ($getUserDetails->data[0]->signature_img2 != '') {
								...
								//echo 'Date : '.$date;
                                            ...
                                            $queryProof3 = "SELECT * FROM tk_page_manage_translation WHERE pmt_id='82' AND pmt_noti='TRUE' "; 
                                            ...
                                            if($resultProof3->num_rows > 0){ 
                                                ...
                                                $a = explode('/',$rowProof3['pmt_lastupdated']);
                                                $dateFormat3 = (int)($a[2].$a[1].$a[0]);
						...
						<div class="col-lg-12">
							...
							if ($getUserDetails->data[0]->signature_img2 != '') {
                                            ...
                                            $queryProof4 = "SELECT * FROM tk_page_manage_translation WHERE pmt_id='82' AND pmt_noti='TRUE' "; 
                                            ...
                                            if($resultProof4->num_rows > 0){ 
                                                ...
                                                $a = explode('/',$rowProof4['pmt_lastupdated']);
                                                $dateFormat4 = (int)($a[2].$a[1].$a[0]);
							...
							if ($getUserDetails->data[0]->signature_img2 != '') {
                                            ...
                                            $queryProof5 = "SELECT * FROM tk_page_manage_translation WHERE pmt_id='82' AND pmt_noti='TRUE' "; 
                                            ...
                                            if($resultProof5->num_rows > 0){ 
                                                ...
                                                $a = explode('/',$rowProof5['pmt_lastupdated']);
                                                $dateFormat5 = (int)($a[2].$a[1].$a[0]);
