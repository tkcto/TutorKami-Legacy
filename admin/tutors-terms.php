...
if(isset($_REQUEST['crs-saveBI'])){
 ...
 $res =  $instApp->SaveTutorsTermsConditionBI($data);
 
 header('Location:tutors-terms.php');
 exit();
}
if(isset($_REQUEST['crs-saveBM'])){
 $data = $instApp->RealEscape($_REQUEST);
 $res =  $instApp->SaveTutorsTermsConditionBM($data);
...
if(isset($_REQUEST['crs-saveBI2'])){
 $data = $instApp->RealEscape($_REQUEST);
 $res =  $instApp->SaveTutorsTermsConditionBI2($data);
...
if(isset($_REQUEST['crs-saveBM2'])){
 $data = $instApp->RealEscape($_REQUEST);
 $res =  $instApp->SaveTutorsTermsConditionBM2($data);
...
$queryTCBI = $conDB->query("SELECT * FROM tk_page_manage_translation WHERE pmt_id='76'");
...
$queryTCBM = $conDB->query("SELECT * FROM tk_page_manage_translation WHERE pmt_id='77'");
...
$queryTCBI2 = $conDB->query("SELECT * FROM tk_page_manage_translation WHERE pmt_id='82'");
...
$queryTCBM2 = $conDB->query("SELECT * FROM tk_page_manage_translation WHERE pmt_id='83'");
        ...
        <div class="col-lg-12">
         <div class="ibox float-e-margins">
          <div class="ibox-title">
           <h5><b>Tutors Terms & Condition Form</b> <span>(Last updated on <strong id="lastUpdated"></strong>)</span></h5>
...
<div class="container">
    ...
    <div class="tab-group rates-page-tabs">
        ...
        <ul class="nav nav-tabs responsive" role="tablist">
            <li role="presentation" class="active"><a href="#Personal" aria-controls="Personal" role="tab" data-toggle="tab" onClick="activeTabMain(this.id)" id="1" >Terms of Accepting 1-to-1 Tuition Job</a></li>
            <li role="presentation"><a href="#Group" aria-controls="Group" role="tab" data-toggle="tab" onClick="activeTabMain(this.id)" id="2" >Additional terms: Group Tuition</a></li>
        </ul>
			...
			<form class="form-horizontal" action="" method="post">                            
				...
				<div class="col-lg-12">
					<br/><button class="btn btn-sm btn-primary sign-btn-box" type="submit" name="crs-saveBI"><span class="glyphicon glyphicon glyphicon-ok"></span> &nbsp; Save</button>
					     <button class="btn btn-sm btn-primary sign-btn-box" type="button" onClick="SaveNoti(this.id)" id="1">Save & Notify Tutor</button>
			...
			<!--<form class="form-horizontal" action="" method="post"> -->                           
				...
				<div class="col-lg-12">
					<br/><button class="btn btn-sm btn-primary sign-btn-box" type="submit" name="crs-saveBM"><span class="glyphicon glyphicon glyphicon-ok"></span> &nbsp; Save</button>
					     <button class="btn btn-sm btn-primary sign-btn-box" type="button" onClick="SaveNoti(this.id)" id="2">Save & Notify Tutor</button>
			...
			<form class="form-horizontal" action="" method="post">                            
				...
				<div class="col-lg-12">
					<br/><button class="btn btn-sm btn-primary sign-btn-box" type="submit" name="crs-saveBI2"><span class="glyphicon glyphicon glyphicon-ok"></span> &nbsp; Save</button>
					     <button class="btn btn-sm btn-primary sign-btn-box" type="button" onClick="SaveNoti(this.id)" id="3">Save & Notify Tutor</button>
			...
			<!--<form class="form-horizontal" action="" method="post">  -->                          
				...
				<div class="col-lg-12">
					<br/><button class="btn btn-sm btn-primary sign-btn-box" type="submit" name="crs-saveBM2"><span class="glyphicon glyphicon glyphicon-ok"></span> &nbsp; Save</button>
					     <button class="btn btn-sm btn-primary sign-btn-box" type="button" onClick="SaveNoti(this.id)" id="4">Save & Notify Tutor</button>
...
function DownloadPDF(id) {
  if(id == '1'){
      window.open("https://www.tutorkami.com/admin/pdf1.php");
  }
  if(id == '2'){
      window.open("https://www.tutorkami.com/admin/pdf2.php");
  }
  if(id == '3'){
      window.open("https://www.tutorkami.com/admin/pdf3.php");
  }
  if(id == '4'){
      window.open("https://www.tutorkami.com/admin/pdf4.php");
  }
