...
if(isset($_REQUEST['cd'])){
    ...
    $query = $conDB->query("SELECT * FROM tk_classes INNER JOIN tk_classes_record ON cr_cl_id = cl_id WHERE cr_id=$valueURl");
    $res = $query->num_rows;
    if($res > 0){
        if($row = $query->fetch_assoc()){ 
            $JobID  = $row['cl_display_id'];
            $iD  = $row['cr_id'];
            $iD2 = $row['cr_cl_id'];
            $date  = $row['cr_date'];
...
<head>
  ...
  <?php 
  $title = 'Classes Details | Tutorkami';
        ...
        <div class="col-lg-12">
         <div class="ibox float-e-margins">
          <div class="ibox-title">
           <h5><b>Edit Classes Details</b></h5>
...
-->
        ...
        <input type="hidden" class="form-control" name="JobID" id="JobID" value="<?php echo $JobID; ?>" required>
 ...
 <div id="out"></div>-->
                        <div class="form-group">
                           ...
                           <div class="col-lg-7">
                              <div class="input-group date">
                                 <input data-field="time" data-format="hh:mm AA" type="text" class="form-control" name="start" id="start" value="<?php echo $start; ?>">   
                              </div>
                           </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-lg-7">
                              <div class="input-group">
                                <!--<input type="text"  class="form-control" name="parent_ver" id="parent_ver" value="<?php echo $parentVer;  ?>" disabled>-->
...
function backToClasses() {
   //var cr_cl_id = $('#cr_cl_id').val();
   //window.location ='classes-add?cl='+cr_cl_id;
   var JobID = $('#JobID').val();
   window.location ='classes-add?cl='+JobID;
}
</script> 
</div> 
