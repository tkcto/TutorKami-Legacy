      ...
      <script type="text/javascript">
        $(document).ready(function() {
          ...
          $('#registration-form').validate({
            ...
            //errorClass: 'testing',
    /*errorElement: 'span',
    eerrorClass: 'errorToShow',
    rrorLabelContainer: '#errMsg'*/
    errorClass: 'testing',
            rules: {
     ...
     //alert(validator);
           ...
           var errors = validator.numberOfInvalids();
            ...
            errorPlacement: function (error, element) {
                //if ( (element.attr("name") == "u_email") || (element.attr("name") == "u_password") || (element.attr("name") == "con_password") || (element.attr("name") == "ud_first_name") || (element.attr("name") == "ud_last_name") || (element.attr("name") == "u_displayname")      ) {
                if ( (element.attr("name") == "u_email") ) {
                    error.appendTo("#messageBoxEmail");
                } else {
...
{
    $styleMargin = "style='margin-top:-25px;'";
}else{
    $styleMargin = "";
}
?>
                ...
                <div class="row rdc_pad">
                  ...
                  <div class="col-md-4">
                    ...
                    <select class="form-control" id="ud_dob_1" name="ud_dob[0]">
                      ...
                      <option value="" data-rule-required="true" data-msg-required="- Date of birth is required"><?php echo DOB_DAY; ?></option>
...
<span id="messageBoxConductOnline" style="color:#dc3545"></span><span id="messageBoxHiddentoolsname1" style="color:#dc3545"></span>
                <div class="row">
                    ...
                    <!--<label>
                      <input type="text" id="conduct_onlineError" name="conduct_onlineError" style="width: 2px;height: 2px;border:none;background-color:#f3f3f5;color:#f3f3f5;" data-rule-required="true" data-msg-required="- This detail is required">
                    </label>-->
                     
                    </div>
                </div>
                <div id="conduct_online_wrap" class="hidden" style="">
 
					<div class="dropbox" style="background-color:white;">Tools</div>
					<div class="dropPop">
						<div class="row">
							<div class="col-xs-12">
            ...
            <div class="form-group" <?PHP //echo $styleMargin; ?> >
...
<span id="messageBoxConductClass" style="color:#dc3545"></span>
                <!--<div class="row">
                  <div class="col-md-6">
                    <label class="radio-inline" style="font-size:15px;">
                      <input type="radio" name="conduct_class" value="Yes" <?php //echo isset($_POST['conduct_class']) && $_POST['conduct_class'] == 'Yes' ? 'checked' : (!isset($_POST['conduct_class']) ? '' : '');?> >
                      <?php //echo YES; ?></label>
                  </div>
    		...
    		<div class="input-group">
    			...
    			<span class="input-group-addon"></span>
                    ...
                    <label style="margin-left:15px;">
                      <input type="text" id="ud_tutor_experienceError" name="ud_tutor_experienceError"  style="width: 2px;height: 2px;border:none;background-color:#f3f3f5;color:#f3f3f5;" >
                    </label>
...
$("#ud_tutor_experience").inputFilter(function(value) {
 ...
 $(document).ready(function(){
      ...
      function conduct_online() {
        var v = $('input[name=conduct_online]:checked').val();
        if (v == 'Yes') {
           //document.getElementById("conduct_onlineError").value = "Yes";
           ...
           //document.getElementById("conduct_onlineError").value = "No";
