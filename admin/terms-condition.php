...
if(isset($_REQUEST['crs-saveBI'])){
 ...
 $res =  $instApp->SaveTermsConditionBI($data);
 
 header('Location:terms-condition.php');
 exit();
}
if(isset($_REQUEST['crs-saveBM'])){
 $data = $instApp->RealEscape($_REQUEST);
 $res =  $instApp->SaveTermsConditionBM($data);
...
$queryTCBI = $conDB->query("SELECT * FROM tk_page_manage_translation WHERE pmt_id='33'");
...
$queryTCBM = $conDB->query("SELECT * FROM tk_page_manage_translation WHERE pmt_id='34'");
        ...
        <div class="col-lg-12">
         <div class="ibox float-e-margins">
          <div class="ibox-title">
           <h5><b>Terms & Condition Form</b></h5>
