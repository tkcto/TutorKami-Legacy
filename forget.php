   ...
   <div class="container">
      ...
      <div class="col-md-12" align="center">
         ...
         <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 mrg_top30">
            ...
            <form id="form_id" action="forget.php" method="post" class="form-horizontal">
            ...
            <i class="fa fa-angle-left" aria-hidden="true"></i> <span><a href="client_login.php"> <?php echo BUTTON_GO_BACK; ?> </a></span>
