...
if ($resultState->num_rows > 0) {
    ...
    while($rowState = $resultState->fetch_assoc()){
                ...
                $resultIn = 'https://www.tutorkami.com/private-tutors?/'.$stateName;
    ...
    while($rowState = $resultState->fetch_assoc()){
        ...
        if ($resultCity->num_rows > 0) {
            while($rowCity = $resultCity->fetch_assoc()){
                ...
                $resultIn = 'https://www.tutorkami.com/private-tutors?/'.$cityName.'/'.$stateName;
...
if ($resultState->num_rows > 0) {
    ...
    while($rowState = $resultState->fetch_assoc()){
                ...
                $stateName = str_replace(' ', '-', $rowState['tc_title']);  // Replacing Spaces with -
                $resultIn = 'https://www.tutorkami.com/private-tutors?/'.$stateName;
    ...
    while($rowState = $resultState->fetch_assoc()){
        ...
        if ($resultCity->num_rows > 0) {
            while($rowCity = $resultCity->fetch_assoc()){
                ...
                $stateName = str_replace(' ', '-', $rowState['tc_title']);  // Replacing Spaces with -
                $cityName = str_replace(' ', '-', $rowCity['ts_title']);  // Replacing Spaces with -
                $resultIn = 'https://www.tutorkami.com/private-tutors?/'.$cityName.'/'.$stateName;
    ...
    while($rowState = $resultState->fetch_assoc()){
        ...
        if ($resultCity->num_rows > 0) {
            while($rowCity = $resultCity->fetch_assoc()){
                ...
                $stateName = str_replace(' ', '-', $rowState['st_name']);  // Replacing Spaces with -
                $cityName = str_replace(' ', '-', $rowCity['tc_title']);  // Replacing Spaces with -
                $resultIn = 'https://www.tutorkami.com/private-tutors?/'.$cityName.'/'.$stateName;
            ...
            while($rowCity = $resultCity->fetch_assoc()){
                ...
                if ($resultLevel->num_rows > 0) {
                    while($rowLevel = $resultLevel->fetch_assoc()){
                        ...
                        $resultIn = 'https://www.tutorkami.com/private-tutors?/'.$LevelName.'/'.$cityName.'/'.$stateName;
                    ...
                    while($rowLevel = $resultLevel->fetch_assoc()){
                        ...
                        if ($resultCourse->num_rows > 0) {
                            while($rowCourse = $resultCourse->fetch_assoc()){
                                ...
                                $resultIn = 'https://www.tutorkami.com/private-tutors?/'.$CourseName.'/'.$LevelName.'/'.$cityName.'/'.$stateName;
...
// START STATE, CITY, LEVEL & COURSE ONLY
  ...
  header('Content-Disposition: attachment; filename=auto-sitemap-private-tutors.xml');
  echo $output;
