        ...
        <p><span class="rad-txt">*</span> <?php echo REQUIRED; ?><br>
          ...
          <form class="form-horizontal" method="post" enctype="multipart/form-data" id="registration-form">
            ...
            <div class="form-group">
              <label class="control-label col-sm-4"><?php echo VIDEO; ?></label>
              <div class="col-sm-8">
                <span>Share your video profile with us via Telegram and state your name & ID number there. We will then upload it to your profile through our YouTube channel :</span>
...
?>
            ...
            <div class="form-group">
              <label class="control-label col-sm-4" for="conduct_online"><?php echo CONDUCT_ONLINE; ?> *
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8 radio_font">
                <div class="row">
                  <div class="col-md-6">
                    <label class="radio-inline" style="font-size:15px;">
                      <input type="radio" name="conduct_class" value="Yes" <?php echo isset($user_info['conduct_class']) && $user_info['conduct_class'] == 'Yes' ? 'checked' : '';?> data-rule-required="true" data-msg-required="- Conduct class is required.">
                      <?php echo YES; ?></label>
                  </div>
              ...
              <div class="col-sm-8">
                ...
                <div class="row">
                  ...
                  <div class="col-md-2 col-sm-2">
                    ...
                    <input style="width: 50px;" onkeypress="return isNumberKey(event)" maxlength="2" type="text" class="form-control" id="ud_tutor_experience" name="ud_tutor_experience" value="<?php echo isset($user_info['ud_tutor_experience']) ? $user_info['ud_tutor_experience']: '';?>">


                  </div>

                  <div class="col-md-4 col-sm-4">
                    <select class="form-control" name="experienceMonth" id="experienceMonth" data-rule-required="true" data-msg-required="- Experience is required." style="width: 140px;">
